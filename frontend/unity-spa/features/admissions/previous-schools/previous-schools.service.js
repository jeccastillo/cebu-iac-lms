(function () {
  ...
  angular
    .module('unityApp')
    .factory('PreviousSchoolsService', PreviousSchoolsService);

  PreviousSchoolsService.$inject = ['$http', 'APP_CONFIG', 'StorageService'];
  function PreviousSchoolsService($http, APP_CONFIG, StorageService) {
    var BASE = APP_CONFIG.API_BASE; // e.g. /laravel-api/public/api/v1
    var ROOT = BASE + '/previous-schools';
    var PUBLIC_ROOT = BASE + '/admissions/previous-schools'; // read-only endpoint for applicant forms
