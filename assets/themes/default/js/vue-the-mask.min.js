!function(e, t) {
    ...
    , function(e, t, o) {
        ...
        t.a = function(r, e) {
            ...
            "INPUT" !== r.tagName.toLocaleUpperCase()) {
                var t = r.getElementsByTagName("input");
                if (1 !== t.length)
                    throw new Error("v-mask directive requires 1 input, found " + t.length);
                r = t[0]
            }
            r.oninput = function(e) {
                if (e.isTrusted) {
                    var t = r.selectionEnd
                      , n = r.value[t - 1];
                    for (r.value = o.i(u.a)(r.value, a.mask, !0, a.tokens); t < r.value.length && r.value.charAt(t - 1) !== n; )
                        t++;
                    r === document.activeElement && (r.setSelectionRange(t, t),
                    setTimeout(function() {
                        r.setSelectionRange(t, t)
                    }, 0)),
                    r.dispatchEvent(i("input"))
                }
            }
            ;
            var n = o.i(u.a)(r.value, a.mask, !0, a.tokens);
            n !== r.value && (r.value = n,
            r.dispatchEvent(i("input")))
        }
    }
    , function(e, t, a) {
        ...
        t.a = function(e, t) {
            var n = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2]
              , r = arguments[3];
            return (Array.isArray(t) ? a.i(i.a)(o.a, t, r) : a.i(o.a))(e, t, n, r)
        }
    }
    , function(e, t, n) {
        "use strict";
    ...
    , function(e, t, n) {
        ...
        t.default = {
            ...
            methods: {
                ...
                refresh: function(e) {
                    this.display = e,
                    (e = n.i(i.a)(e, this.mask, this.masked, this.tokens)) !== this.lastValue && (this.lastValue = e,
                    this.$emit("input", e))
                }
            }
        }
    ...
    , function(e, t, n) {
        "use strict";
        t.a = function(i, u, s) {
            return u = u.sort(function(e, t) {
                return e.length - t.length
            }),
            function(e, t) {
                for (var n = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2], r = 0; r < u.length; ) {
                    var a = u[r]
                      , o = u[++r];
                    if (!(o && i(e, o, !0, s).length > a.length))
                        return i(e, a, n, s)
                }
                return ""
            }
    ...
    , function(e, t, n) {
        ...
        t.a = function(e, t) {
            ...
            for (var a = 0, o = 0, i = ""; a < t.length && o < e.length; ) {
                var u = r[f = t[a]]
                  , s = e[o];
                u && !u.escape ? (u.pattern.test(s) && (i += u.transform ? u.transform(s) : s,
                a++),
                o++) : (u && u.escape && (f = t[++a]),
                n && (i += f),
                s === f && o++,
    ...
    , function(e, t) {
        e.exports = function(e, t, n, r) {
            ...
            "object" != i && "function" != i || (o = (a = e).default);
