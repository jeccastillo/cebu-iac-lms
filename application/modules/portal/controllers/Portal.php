...
class Portal extends CI_Controller {
    ...
    public function enlistment_data($id,$sem){
        ...
        $data['enlistment'] = $this->db->get_where('tb_mas_student_enlistment',array('student_id'=>$id,'term_id'=>$sem))->first_row();
        
        if($data['enlistment']){
            $enlisted_subjects = $this->db->get_where('tb_mas_student_enlistment',array('enlistment_id'=>$data['enlistment']->id))->result_array();
