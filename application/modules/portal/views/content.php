    ...
    <div class="box box-warning">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <template v-for="item in getRecordsWithCombined({records: records})">
                        <tr v-if="item.type == 'combined'" style="font-size: 13px;">
                            ...
                            <td v-if="item.data.include_gwa == 1">{{ getTotalUnits({records: records}, item.data.intSubjectID) }}</td>
                            <td v-else>({{ getTotalUnits({records: records}, item.data.intSubjectID) }})</td>
                            <td>{{ getAverageMidterm({records: records}, item.data.intSubjectID) }}</td>
                            <td>{{ getAverageFinal({records: records}, item.data.intSubjectID) }}</td>
                            <td>{{ getAverageSemFinal({records: records}, item.data.intSubjectID) }}</td>
                            <td>Combined</td>
                            <td>---</td>
                        </tr>
