<link rel="stylesheet"
    href="<?php echo base_url(); ?>assets/themes/default/css/datepicker.min.css">
    ...
    <div class="container">
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <p>
                                ...
                                <span class="text-muted"
                                    v-if="request.status ==  'For Interview'">For
                                    Interview</span>
                                <span class="text-muted"
                                    v-if="request.status ==  'Waiting For Interview'">Waiting
                                    For
                                    Interview</span>
                                <span class="text-muted"
                                ...
                                <span class="text-muted"
                                    v-if="request.status ==  'For Enrollment'">For
                                    Enrollment</span>
                                <span class="text-muted"
                                ...
                                <span class="text-muted"
                                    ...
                                    Reserve</span>
                                <span class="text-muted"
                                    v-if="request.status ==  'Floating'">Floating
                                    Application</span>
                                <span class="text-muted"
                                ...
                                <span class="text-muted"
                                    v-if="request.status ==  'Withdrawn After'">Withdrawn
                                    Enrollment After Opening of SY</span>
                                <span class="text-muted"
                                    v-if="request.status ==  'Withdrawn End'">Withdrawn
                    ...
                    <div v-if="true">
                        ...
                        <div class="form-inline">
                            <input type="text"
                                ...
                                @blur="updateField('school_name',$event)"
                                :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right"
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text"
                                ...
                                @blur="updateField('place_of_birth',$event)"
                                :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right"
                    ...
                    <div v-if="request.type == 'other'">
                        ...
                        <div class="form-inline">
                            <input type="text"
                                ...
                                @blur="updateField('sd_company',$event)"
                                :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right"
                    ...
                    <div v-if="request.type == 'other'">
                        ...
                        <div class="form-inline">
                            <input type="text"
                                ...
                                @blur="updateField('sd_position',$event)"
                                :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right"
                    ...
                    <div v-if="request.type == 'other'">
                        ...
                        <div class="form-inline">
                            <input type="text"
                                ...
                                @blur="updateField('sd_degree',$event)"
                                :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right"
            ...
            <div class="col-md-6 box">
                ...
                <div class="box-body">
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <select v-if="request.campus == 'Cebu'"
                                class="form-control"
                                :disabled="true"
                ...
                <div class="box-body">
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text"
                                class="form-control"
                                v-model="request.schedule_date"
                                @blur="updateField('schedule_date',$event)"
                                :disabled="true" />
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text"
                                class="form-control"
                                v-model="request.interview_mode"
                                @blur="updateField('interview_mode',$event)"
                                :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right"
        ...
        <div class="row-container"
            ...
            <div v-if="false"
                ...
                <div class="box-header with-border font-weight-bold ">
                    <h5 class=" text-left text-primary ">
                        <strong> applicant status update</strong>
                    </h5>
                </div>
                <div class="box-body">
                    <form method="post"
                        @submit.prevent="updateStatusManual">
                        <label>Manual Status</label>
                        <select required
                            v-model="status_update_manual"
                            class="form-control">
        ...
        <div class="row-container"
            ...
            <div class="col-md-6 box">
                ...
                <div class="box-body">
                    ...
                    <div>
                        <strong>Holds a good moral standing in previous school</strong>
                        <div class="form-inline">
                            <select class="form-control"
                                :disabled="true"
                    ...
                    <div>
                        <strong :class="request.crime=='Yes'?'text-red':''">Has been involved of any
                            illegal activities</strong>
                        <div class="form-inline">
                            <select class="form-control"
                                :disabled="true"
                                @change="updateField('crime',$event)"
            ...
            <div class="col-md-6 box">
                ...
                <div class="box-body">
                    ...
                    <div>
                        <strong>Recommended Scholarship(Admissions)</strong>
                        <p class="text-muted">VLT Scholarship</p>
                        <hr>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text"
                                ...
                                @blur="updateField('mother_occupation',$event)"
                                :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right"
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text"
                                class="form-control"
                                v-model="request.mother_contact"
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text"
                                ...
                                @blur="updateField('father_occupation',$event)"
                                :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right"
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text"
                                class="form-control"
                                v-model="request.father_contact"
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text"
                                class="form-control"
                                v-model="request.guardian_email"
        ...
        <div action="">
            <div class="box ">
                <div class="box-header with-border font-weight-bold py-5"
                    ...
                    <h3 class="box-title text-left text-primary "
                ...
                <div class="box-body"
                    ...
                    <div>
                        ...
                        <input type="date"
                            class="form-control"
                            v-model="request.date_enrolled_u"
                    ...
                    <div>
                        <strong :class="request.crime=='Yes'?'text-red':''"><i
                                class="fa fa-user margin-r-5"></i>Has
                    ...
                    <div class=""
                        v-if="request.uploaded_requirements.length > 0">
                    ...
                    <div class="text-right">
                        ...
                        <button type="button"
                            ...
                            data-toggle="modal"
                            @click="update_status = 'For Interview';"
                            data-target="#myModal"
                            class=" btn
                            btn-primary">For
                            Interview</button>
                        <button type="button"
                            v-if="request.status == 'For Interview'"
                            @click="update_status = 'For Reservation'"
                            data-toggle="modal"
                            data-target="#myModal"
                        ...
                        <button type="button"
                            ...
                            @click="update_status = 'For Enrollment'"
                            data-toggle="modal"
                            data-target="#myModal"
                            class=" btn btn-info">For
                            Enrollment</button>
                        ...
                        <a :href="base_url+'admissionsV1/update_requirements/'+slug"
...
new Vue({
    ...
    methods: {
        ...
        updateField: function(type, event) {
            ...
            axios
                .post(api_url + 'admissions/student-info/update-field/custom/' + this
                    .slug, this.payload, {
                        headers: {
            ...
            Swal.fire({
                ...
                document.location = base_url + 'admissionsV1/view_lead/' + this
                    .slug;
        ...
        updateStatus: function() {
            ...
            Swal.fire({
                ...
                preConfirm: (login) => {
                    ...
                    return axios
                        .post(api_url + 'admissions/student-info/' + this
                            .slug +
                            '/update-status', {
