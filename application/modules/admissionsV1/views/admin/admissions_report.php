...
<script>
<?php if($start!=0): ?>
    var query_str = 'admissions/applications/adstats?current_sem=<?php echo $active_sem['intID']; ?>&campus=<?php echo $campus; ?>&term=<?php echo $current_sem; ?>&start=<?php echo $start; ?>&end=<?php echo $end; ?>';
<?php else: ?>
    var query_str = 'admissions/applications/adstats?current_sem=<?php echo $active_sem['intID']; ?>&campus=<?php echo $campus; ?>&term=<?php echo $current_sem; ?>';
<?php endif; ?>
new Vue({
