                           ...
                           v-if="request.email && request.citizenship != 'Philippines'">
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload1.png"
                                        class="img-responsive" style="padding:15px" title='Photocopy of the valid (unexpired) passport pages bearing the bio-page, 
                                ...
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload2.png"
                                        class="img-responsive" style="padding:15px" title='Copy of Alien Certificate of Registration (i-CARD) if any'>                                    
                           ...
                           v-if="request.email && request.citizenship != 'Philippines'">                                
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload5.png"
                                        class="img-responsive" style="padding:15px" title='Original copy of Scholastic Records'>                                    
                                ...
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload7.png"
                                        class="img-responsive" style="padding:15px" title="Proof of adequate financial support to cover expenses for the student's accommodation and subsistence, as well as school dues and other incidental expenses (to be notarized by a lawyer in the country of residence) and to be authenticated by the Philippine Embassy.">                                    
