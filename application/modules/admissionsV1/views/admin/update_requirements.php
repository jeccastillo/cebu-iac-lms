                           ...
                           v-if="request.email && request.citizenship != 'Philippines'">
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload1.png"
                                        class="img-responsive" title='Photocopy of the valid (unexpired) passport pages bearing the bio-page, 
                                ...
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload2.png"
                                        class="img-responsive" title='Copy of Alien Certificate of Registration (i-CARD) if any'>                                    
                                ...
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload3.png"
                                        class="img-responsive" title='Quarantine Medical Examination by the Bureau of Quarantine (BOQ)'>                                    
                                ...
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload4.png"
                                        class="img-responsive" title='Copy of Birth Certificate.'>
                           ...
                           v-if="request.email && request.citizenship != 'Philippines'">                                
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload5.png"
                                        class="img-responsive" title='Original copy of Scholastic Records'>                                    
                                ...
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload6.png"
                                        class="img-responsive" title='Recommendation letter from the Principal/Guidance Counselor/Class Adviser'>                                    
                                ...
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload7.png"
                                        class="img-responsive" title="Proof of adequate financial support to cover expenses for the student's accommodation and subsistence, as well as school dues and other incidental expenses (to be notarized by a lawyer in the country of residence) and to be authenticated by the Philippine Embassy.">                                    
                                ...
                                <div class="col-md-3">
                                    <img src="<?php echo $img_dir; ?>admissions/form/upload8.png"
                                        class="img-responsive" title='2x2 ID picture (white background with name tag below)'>                                    
