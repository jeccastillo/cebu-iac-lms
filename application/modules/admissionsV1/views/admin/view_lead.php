            ...
            <div class="box ">
                ...
                <div class="box-body" style="padding:2rem">
                    ...
                    <div>
                        ...
                        <p class="text-muted">
                            {{request.first_name + ' ' + request.last_name}} <button v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'" class="btn btn-primary" @click="showEdit">{{show_edit_title}}</button>
                        </p>                        
                        <hr>
                    </div>
