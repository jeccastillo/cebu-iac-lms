...
<div class="content-wrapper " id="applicant-container">
    ...
    <div class="container">
            ...
            <div class="col-md-6 box">
                ...
                <div class="box-body">
                    ...
                    <div v-if="true">
                        ...
                        <div class="form-inline">
                            <span class="text-muted">{{request.school}}</span>
                            <!-- <input type="text"
                                class="form-control"
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text" class="form-control" v-model="request.citizenship"
                                @blur="updateField('citizenship',$event)" :disabled="true" />
                            <button
                                v-if="request.status !=  'Game Changer' && request.status !=  'For Enrollment'"
                                class="btn btn-primary text-right" @click="onEdit">Edit</button>
                        </div>
        ...
        <div class="row-container" v-if="true">
            ...
            <div class="col-md-6 box">
                ...
                <div class="box-body">
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <input type="text" class="form-control" v-model="request.tel_number"
                                @blur="updateField('tel_number',$event)" :disabled="true" />
                            <button class="btn btn-primary text-right" @click="onEdit">Edit</button>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="form-inline">
                            <textarea class="form-control" v-model="request.home_address"
                                @blur="updateField('home_address',$event)"
            ...
            <div class="col-md-6 box" v-if="false">
                <div class="box-header with-border font-weight-bold ">
                    <h5 class=" text-left text-primary ">
        ...
        <div class="row-container" v-if="true">
            <!-- 1st row 1st Column -->
            <div class="col-md-6 box" v-if="true">
                <div class="box-header with-border font-weight-bold ">
                    <h5 class=" text-left text-primary ">
                ...
                <div class="box-body box-body-voucher" style="height:292px">
                    ...
                    <div>
                        ...
                        <p class="text-muted">
                            <a :href="request.video_introduction_url" target="_blank"> Link</a>
                        </p>
                        <hr>
                    </div>
                    <!--  -->
...
new Vue({
    ...
    mounted() {
        ...
        // next_school/user/
        axios.get(this.apiUrl + 'next_school/user/' + this.slug).then((data) => {
