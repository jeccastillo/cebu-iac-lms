...
<script type="text/javascript">
    ...
    $('#users_table').dataTable( {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo base_url(); ?>datatables/data_tables_ajax/tb_mas_users/null/null/<?php echo $course; ?>",
            "aoColumnDefs":[
                {
                    "aTargets":[6],
                    "mData": null,
                    "bSortable":false,
                    "mRender": function (data,type,row,meta) { return '<?php echo $d_open; ?><li><a href="<?php echo base_url(); ?>student/edit_student/'+row[0]+'">Edit</a></li><li><a href="#" rel="'+row[0]+'" class="trash-item">Delete</a></li></ul></div>'; }
                },
                {
                    "aTargets":[0],
                    "bVisible": false 
