...
<script type="text/javascript">
    ...
    $('#users_table').dataTable( {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo base_url(); ?>datatables/getStudentsTableRegistered/",
            "aoColumnDefs":[
                {
                    "aTargets":[7],
                    "mData": null,
                    "bSortable":false,
                    "mRender": function (data,type,row,meta) { return '<?php echo $d_open; ?><li><a href="<?php echo base_url(); ?>unity/edit_student/'+row[0]+'">Edit</a></li><li><a href="#" rel="'+row[0]+'" class="trash-item">Delete</a></li><li><a href="<?php echo base_url(); ?>unity/registration_viewer/'+row[0]+'">View Registration</a></li></ul></div>'; }
                },
                {
                    "aTargets":[0],
                    "bVisible": false 
