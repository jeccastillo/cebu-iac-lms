    ...
    <div class="content">
        ...
        <div class="box box-primary">   
            <div class="box-body text-center">
              <h2> Admission period will be available on <?php echo date("l M j, Y",strtotime($date)); ?>.</h2>
                <h3> Please visit the official facebook page of 
                        <a href="https://www.facebook.com/citycollegeoftagaytay">City College of Tagaytay</a> for more information.</h3>
<!--                
                    <h2> Admission period is not yet available. Please visit the official facebook page of 
                        <a href="https://www.facebook.com/citycollegeoftagaytay">City College of Tagaytay</a> for the announcements. Thank you!
                    </h2>
-->
            </div>
        </div>