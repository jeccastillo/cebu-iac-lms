                    ...
                    <tbody>
                        ...
                        <tr v-else v-for="item in deficiencies">
                            ...
                            <td v-if="item.department == request.department && item.status != 'resolved'">
                                <a class="btn btn-primary" @click.prevent="resolveDeficiency(item.id)">Resolve</a><hr />
                                <a v-if="user.intUserLevel == 2 || user.intUserLevel == 3" class="btn btn-success" href="#" data-toggle="modal" data-target="#temporaryResolve" @click="setResolveID(item.id)">Temp Resolve</a>
                            </td>
                            <td v-else></td>
                        </tr>
                    </tbody>
