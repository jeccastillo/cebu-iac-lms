            ...
            <table cellpadding="0" style="color:#333; text-align:left; font-size:10;" width="528px">                                
                <tr>
                    <td>
                        ...
                        <table cellspacing="5px" cellpadding="0"  width="258px" style="color:#333; font-size:9;">
                            <tr>
                                <td width="140px">DOWN PAYMENT</td>
                                <td width="70px" style="text-align:right;">'.number_format($tuition['down_payment'], 2, '.' ,',').'</td>
                            </tr>
                        </table>
                    </td>
                    <td>                                
