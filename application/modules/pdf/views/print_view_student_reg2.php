        ...
        $html .='
            <table cellpadding="0" style="color:#333; text-align:left; font-size:9;" width="528px">                                
                <tr>
                    ...
                    $html .= 
                        '<tr>
                            <td width="140px"></td>
                            <td width="80px" style="text-align:right; font-weight:bold; border-bottom:1px solid #333;">'.number_format($tuition['ti_before_deductions'], 2, '.' ,',').'</td>
                        </tr>
                        </table>
                    </td>
                    <td>                                
            ...
            <table border="0" cellpadding="0" style="color:#333; font-size:9; " width="528px">        
                <tr>
                    ...
                    <td width="264px" style= "font-size:8;">Generated: '.date("Y-m-d h:i A").' '.$user['strFirstname'].' by '.$user['strLastname'].'</td>            
                </tr>
            </table>
            <table border="0" cellpadding="0" style="color:#333; font-size:9; " width="528px">
                <tr>
