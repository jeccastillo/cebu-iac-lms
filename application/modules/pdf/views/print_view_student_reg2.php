                    ...
                    <td width="260px">                                
                        ...
                        $html.=' 
                            <tr>
                                ...
                                <td width="132px" style="border-bottom: 1px solid #555; style="text-align:right">'.$tuition['misc'].'</td>                
                            </tr>';
                    }
                    $html.='                        
                    </table>
