<?php
   ...
   //font setting
    ...
    $html = '<table border="0" cellspacing="0" cellpadding="0" style="color:#333; font-size:9;">
            <tr>
                <td width="20%" align="center" style="text-align:center;vertical-align: middle; border-bottom:1px solid #333"><img src= "https://i.ibb.co/1spYkNx/seal.png"  width="100" height="100"/></td>
