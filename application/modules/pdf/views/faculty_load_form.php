...
<table border="0" cellpadding="2px" style="font-size:8px;border-spacing: 15px 0;">
    ...
    <tr style="text-align:center;">
        <td style="border-top:1px solid #333">GENERATED BY: <?php echo $user['strFirstname']." ".$user['strLastname']; ?></td>
        <td style="border-top:1px solid #333"></td>
        <td style="border-top:1px solid #333"></td>
        <td style="border-top:1px solid #333"></td>
    </tr>
    <tr style="text-align:center;">
        <td style="border-top:1px solid #333">RUNDATE&TIME: <?php echo date('Y-m-d'); ?></td>
        <td style="border-top:1px solid #333"></td>
        <td style="border-top:1px solid #333"></td>
        <td style="border-top:1px solid #333"></td>
    </tr>
