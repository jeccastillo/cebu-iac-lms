...
$html .= '   
     ...
     <br />
    <table border="0" cellpadding="0" style="color:#333; font-size:8;" width="575px">     
     <tr>
      <td width="80px" >&nbsp;</td>
      <td width="250px">&nbsp;</td>
      <td width="113px"></td>
...
$html.= '<table border="0" cellpadding="0" cellspacing="0" style="color:#333; font-size:8;" width="600" >
        ...
        <tr>
            ...
            <td width="245px" style="text-align:left; font-weight:bold;  border-bottom: 1px solid #333;">SUBJECT NAME</td>
                            ...
                            $html.='<tr style="color: black; border-bottom: 0px solid gray;">
                                ...
                                foreach($records as $record) {
                                    ...
                                    $html.='<tr style="color: #333;">
                                            ...
                                            <td width="245px" align ="left"> '.$desc. '</td>
        ...
        $html .='
            ...
            <table border="0" cellpadding="0" style="color:#333; font-size:9; " width="575px">
                <tr>
        ...
        $html .=' <table border="0" cellspacing="5px" cellpadding="0" style="color:#333; font-size:7; " width="575px">        
        <tr>
