...
$html = '
        <table border="0" cellpadding="0" style="color:maroon; font-size:10;">
        <tr>
        ...
        <tr>
            <td colspan = "3" style="text-align:center; color:black; font-size: 10;"><table border="0" cellpadding="0" style="color:maroon; font-size:10;">
                    <tr>
                        <td colspan="4"></td>
                    </tr>
                    <tr>
