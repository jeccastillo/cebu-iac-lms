...
?>
    <tr>
        ...
        <td style="border:1px solid #333;text-align:right;padding-right:5px" width="20%"><?php echo number_format($installment[0], 2, '.', ',') ?> </td>
    </tr>
    <tr>
        <td style="border:1px solid #333;" width="50%"> 2nd installment balance due <?php echo date("F d, Y", strtotime($sy->installment2)) ?></td>
        <td style="border:1px solid #333;text-align:right;padding-right:5px" width="20%"><?php echo number_format($installment[1], 2, '.', ',') ?> </td>
    </tr>
    <tr>
        <td style="border:1px solid #333;" width="50%"> 3rd installment balance due <?php echo date("F d, Y", strtotime($sy->installment3)) ?></td>
        <td style="border:1px solid #333;text-align:right;padding-right:5px" width="20%"><?php echo number_format($installment[2], 2, '.', ',') ?> </td>
    </tr>
    <tr>
        <td style="border:1px solid #333;" width="50%"> 4th installment balance due <?php echo date("F d, Y", strtotime($sy->installment4)) ?></td>
        <td style="border:1px solid #333;text-align:right;padding-right:5px" width="20%"><?php echo number_format($installment[3], 2, '.', ',') ?> </td>
    </tr>
    <tr>
        <td style="border:1px solid #333;" width="50%"> 5th installment balance due <?php echo date("F d, Y", strtotime($sy->installment5)) ?></td>
        <td style="border:1px solid #333;text-align:right;padding-right:5px" width="20%"><?php echo number_format($installment[4], 2, '.', ',') ?> </td>
    </tr>
    <tr>
        <td style="border:1px solid #333;font-weight:bold" width="50%">TOTAL BALANCE</td>
        <td style="border:1px solid #333;font-weight:bold;text-align:right;padding-right:5px" width="20%"><?php echo number_format($total_installment, 2, '.', ',') ?> </td>
    </tr>
<?php elseif($reg['paymentType'] == 'full') :?>
    <tr>
        <td style="border:1px solid #333;font-weight:bold" width="50%">TOTAL BALANCE</td>
        <td style="border:1px solid #333;font-weight:bold;text-align:right;padding-right:5px" width="20%"><?php echo number_format($balance, 2, '.', ',') ?> </td>
    </tr>
<?php endif; ?>
</table>
