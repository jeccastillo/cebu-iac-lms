            ...
            <td width="148" style="text-align:center; color:black;">' .  number_format($payment_division, 2, '.' ,',').  '</td>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td width="140" style="color:black; text-align:right;border: 0px solid maroon;">' .  number_format($tuition['total'] - ($nstp_fee / 2), 2, '.', ','). ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                    </tr>
                   
                    <tr>
                        <td style="border-right: 0px solid maroon;"></td>
                        <td style="border-right: 0px solid maroon;text-align:center;"><img height="25px" src="'.$img_dir.'signat-Accounting.png" /></td>
                    </tr>
                   <tr>
