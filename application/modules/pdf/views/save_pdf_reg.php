...
$html.= '<table border="0" cellpadding="0" style="color:maroon; font-size:8; border: 0px solid maroon;" width="528">
        ...
        <tr>
            ...
            <td width="155" style="color:black; text-align:right; border-right: 0px solid maroon;"> ' . number_format($tuition['tuition'], 2, '.' ,',') . ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
            ...
            <td width="148" style="text-align:center; color:black;">' .  number_format($payment_division, 2, '.' ,',').  '</td>
                    ...
                    <tr>
                        ...
                        $html.= '<td width="155"style="color:black; text-align:right;border-right: 0px solid maroon;"> ' . number_format($total_misc, 2, '.', ',') . ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </td>
                        <td width="145"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Third Payment: </td>
                        <td width="148" style="text-align:center; color:black;">' . number_format($payment_division, 2, '.' ,','). '</td>
                    </tr>
                    <tr>
                        <td width="80" style="border-right: 0px solid maroon;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I.D. Fee:</td>
                        <td width="155" style="color:black; text-align:right; border-right: 0px solid maroon;"> ' .  number_format($tuition['id_fee'], 2, '.' ,','). ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </td>
                    ...
                    <tr>
                        ...
                        <td width="155" style="color:black; text-align:right;border-right: 0px solid maroon;">' . number_format($tuition['lab'], 2, '.', ',') . ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </td>
                        <td></td>
                        <td width="148"></td>
                    </tr>
                    <tr>
                        <td width="80" style="border-right: 0px solid maroon;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SRF:</td>
                        <td width="155" style="color:black; text-align:right;border-right: 0px solid maroon;"> ' .  number_format($tuition['srf'], 2, '.' ,','). ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                        <td></td>
                        <td width="148"></td>
                    </tr>
                    <tr>
                        <td width="80" style="border-right: 0px solid maroon;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SFDF:</td>
                        <td width="155" style="color:black; text-align:right; border-right: 0px solid maroon;">' .  number_format($tuition['sfdf'], 2, '.' ,','). ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>    <td></td>
                        <td width="148"></td>
                    </tr>
                    <tr>
                        <td style="border-right: 0px solid maroon;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Athletic Fee</td>
                        <td width="155" style="color:black; text-align:right; border-right: 0px solid maroon;">' .  number_format($tuition['athletic'], 2, '.' ,','). ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                        <td></td>
                        <td width="148"></td>
                    </tr>
                    <tr>
                        <td width="80" style="border-right: 0px solid maroon;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CSG:</td>
                        <td width="155" style="color:black; text-align:right; border-right: 0px solid maroon;">' .  number_format($tuition['csg']['student_handbook']+$tuition['csg']['student_publication'], 2, '.' ,','). ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                     ...
                     <tr>
                        ...
                        <td width="155" style="color:black; text-align:right;border: 0px solid maroon;">' .  number_format($tuition['total'], 2, '.' ,','). ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                    </tr>
                    <tr>
                        <td style="border-right: 0px solid maroon;">&nbsp;</td>
                        <td width="155" style="color:black; text-align:right; border-right: 0px solid maroon;"></td>
