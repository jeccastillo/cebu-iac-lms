...
<body>
    <div class="sheet-outer A4">
        <section class="sheet padding-5mm">
            ...
            <div style="position:absolute; top: 100px; left: 350px; width: 200px; height: 20px;font-size:12px;">
                <?php echo $is_cash != 1? $remarks:""; ?> </div>
            <div style="position:absolute; top: 60px; left: 600px; width: 200px; height: 20px; font-size:12px">
                <?php echo $or_number; ?> </div>
            <div style="position:absolute; top: 60px; right: -80px; width: 200px; height: 20px; font-size:16px">
                <?php echo $or_number; ?> </div>
            <div style="position:absolute; top: 95px; right: -60px; width: 200px; height: 20px; font-size:12px">
                <?php echo "  ".date("m/d/Y",strtotime($transaction_date)); ?> </div>
            <div style="position:absolute; top: 120px; right: -60px; width: 200px; height: 20px; font-size:12px">
            ...
            <div style="position:absolute; top: 190px; left: 150px; width: 200px; height: 20px; font-size:12px">
                <?php echo $tin; ?> </div>
            <div style="position:absolute; top: 220px; left: 150px; height: 20px; font-size:12px">
                <?php echo $student_address; ?> </div>
            <div style="position:absolute; top: 270px; left: 160px; height: 20px; font-size:12px">
                <?php echo $type." /  ".$term['enumSem']." ".$term['term_label']." ".$term['strYearStart']."-".$term['strYearEnd']; ?>
                <br />
            </div>
            <div style="position:absolute; top: 270px; right: -100px; width: 200px; height: 20px; font-size:12px">
                <?php echo $total_amount_due; ?> </div>
            <div style="position:absolute; top: 325px; right: -100px; width: 200px; height: 20px; font-size:12px">
                <?php echo $total_amount_due; ?> </div>
            <div style="position:absolute; top: 355px; right: -70px; width: 200px; height: 20px; font-size:12px">
                <?php echo $invoice_number; ?></div>
            <div style="position:absolute; top: 355px; left: 350px; width: 200px; height: 20px; font-size:12px">
