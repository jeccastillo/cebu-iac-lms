<div class="custom-container max-w-[1080px] " id="scholarship-form" style="margin-top:4rem;">
    <h1 class="text-4xl font-[900] text-center color-primary"> IDEA Scholarship Program </h1>
    <div class="color-primary text-center">
        <h4 class="font-medium text-2xl mb-5"> Application Form (Makati Campus) <br />
        </h4>
    </div>
        ...
        <div v-if="true" class=" mb-6 mt-10">
            <div class="mb-4">
                <div class="border-[1px] border-neutral-100  rounded-lg mt-5 py-2.5 pl-2.5 pr-2.5">
                    <label class="block color-primary font-bold mb-3 pr-4"> iInnovation, Design, and
                        Entrepreneurship Achievers (IDEA) Scholarship </label>
