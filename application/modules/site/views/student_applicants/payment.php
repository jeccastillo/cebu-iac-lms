            ...
            <div class="md:flex mt-[00px] md:mt-0 h-full items-center justify-center">
                <div class="md:w-12/12 py-3">
                    <div class=" block mx-auto mt-[200px]" data-aos="fade-up">
                        <h1 class="text-4xl font-[900] text-center color-primary"> Admissions </h1>
                        ...
                        <h4 class="text-center">(If you would like to pay on-site please ignore this
                            step)</h4>
                    </div>
        ...
        <form @submit.prevent="submitPayment">
            <div class="flex flex-wrap">
                ...
                <div class="mb-6 md:w-4/12 p-2">
                    <div>
                        <label class="block t color-primary font-bold  mb-3  pr-4"
                            for="inline-full-name"> First Name </label>
                        <input disabled
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                ...
                <div class="mb-6 md:w-4/12 p-2">
                    <div>
                        <label class="block t color-primary font-bold  mb-3  pr-4"
                            for="inline-full-name"> Last Name </label>
                        <input disabled
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                ...
                <div class="mb-6 md:w-4/12 p-2">
                    <div>
                        <label class="block t color-primary font-bold  mb-3  pr-4"
                            for="inline-full-name"> Course </label>
                        <input disabled
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                ...
                <div class="mb-6 md:w-4/12 p-2">
                    <div>
                        <label class="block t color-primary font-bold  mb-3  pr-4"
                            for="inline-full-name"> Mobile Number </label>
                        <input disabled
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                ...
                <div class="mb-6 md:w-4/12 p-2">
                    <div>
                        <label class="block t color-primary font-bold  mb-3  pr-4"
                            for="inline-full-name"> Telephone Number </label>
                        <input disabled
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
            ...
            <div class="md:w-1/2 w-full">
                <div>
                    ...
                    <div>
                        ...
                        <div class="d-flex flex-wrap" style="display:flex; flex:wrap;">
                            <div style="border:1px solid #000" @click="selectPayment(maxx)"
                                ...
                                <img class="img-fluid d-block mx-auto" width="51px" height="35px"
                                    src="<?php echo base_url() . '/assets/img/maxx.jpg';?>" alt="">
                            </div>
                        </div>
                    </div>
                    <div>
                ...
                <div class="d-flex flex-wrap" style="display:flex; flex:wrap;">
                    <div v-for="t in payment_modes" style="border:1px solid #000"
                        @click="selectPayment(t)"
                        class="box_mode_payment d-flex align-items-center justify-content-center mr-3 my-3 p-1"
                        style="display:flex; align-itenms:center;">
                        <img :src="t.image_url" class="img-fluid d-block mx-auto" width="51px"
                            alt="">
                    </div>
                </div>
                <hr>
                ...
                <div class="d-flex flex-wrap" style="display:flex; flex:wrap;">
                    <div v-for="t in payment_modes_nonbanks" style="border:1px solid #000"
                        @click="selectPayment(t)"
                        class="box_mode_payment d-flex align-items-center justify-content-center mr-3 my-3 p-1"
                        style="display:flex; align-itenms:center;">
                        <img class="img-fluid d-block mx-auto" width="51px" :src="t.image_url"
                            alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap my-5" style="margin-top:50px">
                <div v-if="this.selected_mode_of_payment.pchannel == 'bdo_pay'"
                    ...
                    <div style="margin-bottom:10px;">
                        ...
                        <input
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                            type="text" v-model="cardHolderObj.firstName">
                    </div>
                    <div style="margin-bottom:10px;">
                        <span>Cardholder Last Name:</span>
                        <input
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                            type="text" v-model="cardHolderObj.lastName">
                    </div>
                    <div style="margin-bottom:10px;">
                        <span style="width:172px;display:inline-block">Cardholder Email:</span>
                        <input
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                            type="text" v-model="cardHolderObj.email">
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Gateway Fee <span class="font-weight-bold"
                                    ...
                                    {{ selected_mode_of_payment.charge}}% of the gross transaction
                                    amount or Php 25.00 whichever is higher )</span> </td>
                        ...
                        <tr>
                            ...
                            <td style="border-top:1px solid #000" class="text-nowrap w-[100px]"
                                v-if="item"> <span class="font-weight-bold">₱
                                    {{ total_single_format }}</span> </td>
                            <td style="border-top:1px solid #000" class="text-nowrap w-[100px]"
                                v-if="from_cart">
                ...
                <div class="text-right mt-3">
                    ...
                    <div v-else>
                        <button type="submit" :disabled="loading_spinner"
            ...
            <hr />
            <p v-if="payment_type == 'admissions_student_payment_reservation'"><i>Reservation Fee is
                    not refundable and non-transferrable</i></p>
        </form>
        <form ref="bdo_form" action="https://secureacceptance.cybersource.com/pay" method="post">
            <input type="hidden" v-for="(value, name, index) in request_bdo" :name="name"
                :value="value" />
        </form>
    </div>
</section>
...
new Vue({
    ...
    mounted() {
        axios.get(api_url + 'payments/modes?count_content=100', {
            ...
            this.payment_modes = _.filter(data.data.data, item => item.is_nonbank !=
                true);
        ...
        axios.get(api_url + 'admissions/student-info/' + this.slug).then((data) => {
            ...
            if (this.student.status != 'New' && this.student.status !=
                "For Reservation") {
                window.location.href = "/"
            }
            if (this.student.campus == "Cebu") this.item_details.price = this
                .payment_type == 'admissions_student_payment_reservation' ? 10000 :
                500;
            else this.item_details.price = this.payment_type ==
    ...
    methods: {
        selectPayment: function(mode_payment) {
            ...
            this.total_single_format = (this.total_single + parseFloat(this.request
                .mailing_fee)).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
            ...
            let title = (this.payment_type ==
                'admissions_student_payment_reservation') ? 'Reservation Payment' :
                'Application Payment';
            this.payload = {
                "description": title,
                "order_items": [{
        ...
        submitPayment: function() {
            ...
            axios.post(api_url + 'payments', this.payload, {
                headers: {
                    Authorization: `Bearer ${window.token}`
                }
            }).then(data => {
