        ...
        <div class="flex md:space-x-5 mb-6 mt-10">
            <div class="md:w-1/2 w-full">
                ...
                <div class="form-group mb-6">
                    ...
                    <div>
                        <input type="radio" required name="citizenship" v-model="request.citizenship"
                            value="Philippines" />
                        Philippines
                    </div>

                    <div>
                        <input type="radio" required name="citizenship" value="Foreign" v-model="request.citizenship" />
                        Foreign
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="form-group" v-if="request.hospitalized == 'Yes'">
                ...
                <div class="mb-6">
                    <div class="md:w-5/5">
                        ...
                        <div class="d-flex align-items-center" v-for="t in programs" :key="t.id">
                            ...
                            <label :for="'progId-' + t.id"> {{ t.title }}
                                {{ t.strMajor != "None" ? "with Major in " + t.strMajor: '' }}</label>
                        </div>
                    </div>
                </div>
