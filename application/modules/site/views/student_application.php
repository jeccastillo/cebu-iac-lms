       ...
       <div class="color-primary">
           ...
           <p>Hello future Game Changers! Kindly fill out your information sheet. If you have any questions, feel free
            ...
            <p style="margin-top:15px;">
                Note: You are applying for iACADEMY Cebu Campus, if you want to apply to iACADEMY Makati (Main Campus) click <a style="text-decoration: underline;" href="https://portalv2.iacademy.edu.ph/#/admissions/requirement-submission/request-form">here</a>.
            </p>
       </div>
                   ...
                   <div class="mb-6">
                    ...
                    <div class="mb-6">
                       <div class="md:w-5/5">
                           ...
                           <ul class="bg-white border border-gray-200 rounded-lg dark:bg-gray-100 dark:border-gray-100 dark:text-gray-600">    
