                   ...
                   <div class="mb-6">
                    ...
                    <div class="mb-6">
                       <div class="md:w-5/5">
                           ...
                           <div class="d-flex flex items-baseline align-items-center" v-for="t in programs" :key="t.id">
                               <input type="checkbox" class="mr-1 admissions_submission_cb" :id="'progId-' + t.id"
