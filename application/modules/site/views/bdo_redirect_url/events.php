      ...
      <div class="md:flex mt-[00px] md:mt-0 h-full items-center justify-center">
        <div class="md:w-12/12 py-3">
          ...
          <div class="block mx-auto mt-[200px]"
            data-aos="fade-up">
            <img class='m-auto h-[90px]'
              src="https://www.bdo.com.ph/content/dam/bdounibank/en-ph/mcg-digital-marketing/personal-homepage/bdo-pay/BDO-APP-ICON-BLUE_1024.png"
              alt="">
