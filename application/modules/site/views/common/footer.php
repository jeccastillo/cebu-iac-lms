<footer class="my-[100px] text-center md:text-left">
		...
		<div class="md:flex justify-center md:space-x-4">
			...
			<img
				src="<?php echo $img_dir?>footer/ bldg.png"
				class="mx-auto block max-w-full h-auto mb-7"
				alt=""
				data-aos="zoom-in"
			/>
			</div>
			...
			<div>
				...
				<p
				class="text-3xl md:text-5xl font-black color-primary"
				data-aos="fade-up"
				>
				different.
				</p>
				...
				<div class="md:w-1/3">
					<h4
					class="uppercase color-primary font-bold text-2xl"
					data-aos="fade-up"
					>
					<img
						src="<?php echo $img_dir?>footer/ pin.png"
						class="inline-block"
						alt=""
					/>
					Visit Us
					...
					Filinvest Cebu Cyberzone Tower 2 Salinas Drive corner W. Geonzon St., Brgy. Apas, Lahug, Cebu City
					</p>
				</div>
			...
			<div class="md:w-1/3 hidden">
				...
				<div
				class="text-[19px] mt-2 flex space-x-2 items-center justify-center md:justify-start"
				data-aos="fade-up"
				>
				<a href="https://www.facebook.com/iACADEMY" target="_blank">
					<img
					class="img-btn"
					src="<?php echo $img_dir?>footer/ Facebook.png"
					data-aos="zoom-in"
					/>
				</a>
				<a
				...
				>
					<img
					class="img-btn"
					src="<?php echo $img_dir?>footer/ Instagram.png"
					data-aos="zoom-in"
					/>
				</a>
				<a
					href="https://www.youtube.com/user/iacademycollege"
					target="_blank"
				>
					<img
					class="img-btn"
					src="<?php echo $img_dir?>footer/ Youtube.png"
					data-aos="zoom-in"
				/></a>
				<a href="https://twitter.com/iacademy_edu" target="_blank">
					<img
					class="img-btn"
					src="<?php echo $img_dir?>footer/ Twitter.png"
					data-aos="zoom-in"
					/>
				</a>
				</div>
