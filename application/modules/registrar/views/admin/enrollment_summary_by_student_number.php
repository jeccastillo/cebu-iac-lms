<aside class="right-side">
    <section class="content-header">
        <h1> Enrollment Summary <small>
                <a class="btn btn-app" href="<?php echo base_url(); ?>registrar/registrar_reports">
                    <i class="ion ion-arrow-left-a"></i> All Reports </a>
            </small>
            <small>
                <button class="btn btn-app" id="enrollment_summary_pdf" target="_blank" href="#"><i
                        class="fa fa-book"></i>Print PDF</button>
            </small>
            <small>
                <button class="btn btn-app" id="enrollment_summary_excel" target="_blank"
                    href="#"><i class="fa fa-book"></i>Download Excel</button>
            </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Enrollment Summary </a></li>
    ...
    <div class="content">
        <div class="box box-solid box-default">
            <div class="box-header">
                ...
                <h3 class="box-title">Enrollment Summary</h3>
                <div class="box-tools">
                </div>
            </div><!-- /.box-header -->
            <div class="box-body table-responsive">
                <table id="enrollment-summary-table" class="table table-hover">
                    <thead>
                        <tr>
                        </tr>
                    </thead>
