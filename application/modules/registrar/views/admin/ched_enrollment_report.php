<aside class="right-side" >
    <section class="content-header">
        <h1>
            ...
            <small>
            <button class="btn btn-app" id="ched_enrollment_report_pdf" target="_blank" href="#" ><i class="fa fa-book"></i>Print PDF</button>
            </small>
            <small>
            <button class="btn btn-app" id="ched_enrollment_report_excel" target="_blank" href="#" ><i class="fa fa-book"></i>Download Excel</button>
            </small>
