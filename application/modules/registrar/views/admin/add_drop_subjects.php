    ...
    <div class="content">
        <div class="box box-solid box-default">
            <div class="box-header">
                ...
                <h3 class="box-title"> Add/Drop/Change Subject</h3>
                <div class="box-tools">
                </div>
            </div><!-- /.box-header -->
            <div class="box-body table-responsive">
                <table id="shs-student-grade-table" class="table table-hover">
                    <thead>
                        <tr>
                        </tr>
                    </thead>
