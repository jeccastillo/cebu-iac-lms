<aside class="right-side" id="container">
    <section class="content-header">
        <h1>
            Import Subject Offering
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Subject</a></li>
            <li class="active">Upload Subject Offering</li>
        </ol>
    </section>
    <div class="content">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-4">
                        ...
                        <input @change="attachFile" type="file" size="20" />
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-4">
                        <!-- <input type="submit" value="Import" class="btn btn-lg btn-default  btn-flat"> -->
                        <button class="btn btn-app" @click="importSubjectOffering">Import</button>
                    </div>
                </div>
            </div>
            <!-- </form> -->
...
new Vue({
    ...
    methods: {
        ...
        async importSubjectOffering() {
            ...
            formData.append('import_subject_offering', this.attachment)

            Swal.showLoading();
            const {
                data
            } = await axios
                .post('<?php echo base_url(); ?>excel/import_subject_offering/' + this.sem,
                    formData, {})
                .then(data => {
                    Swal.hideLoading();
                    console.log(data);
