<aside class="right-side">
    <section class="content-header">
        <h1>
            ...
            <small>
                <button class="btn btn-app"
                    id="shs_by_grade_level_list_pdf"
                    target="_blank"
                    href="#"><i class="fa fa-book"></i>Print PDF</button>
            </small>
            <small>
                <button class="btn btn-app"
                    id="shs_by_grade_level_excel"
                    target="_blank"
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>SHS Grade Level</a></li>
            <li class="active">View All SHS Grade Level</li>
        </ol>
        <hr />
    ...
    <div class="content">
        <div class="box box-solid box-default">
            <div class="box-header">
                ...
                <h3 class="box-title"> SHS Grade Level</h3>
                <div class="box-tools">

                </div>
            </div><!-- /.box-header -->
            <div class="box-body table-responsive">
                <table id="shs-grade-table"
