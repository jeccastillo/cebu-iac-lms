<aside class="right-side">
    <section class="content-header">
        <h1> SHS GWA Rank <small>
                <a class="btn btn-app" href="<?php echo base_url(); ?>registrar/registrar_reports">
                    <i class="ion ion-arrow-left-a"></i> All Reports </a>
            </small>
            <small>
                <button class="btn btn-app" id="shs_gwa_rank_list_pdf" target="_blank" href="#"><i
                        class="fa fa-book"></i>Print PDF</button>
            </small>
            <small>
                <button class="btn btn-app" id="shs_gwa_rank_list_excel" target="_blank" href="#"><i
                        class="fa fa-book"></i>Download Excel</button>
            </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>SHS GWA Rank</a></li>
            <li class="active">View All SHS GWA Rank</li>
        </ol>
        <hr />
        <form class="form-inline text-right" style="display: flex;justify-content: end;gap: 10px;">
            ...
            <div class="">
                <select id="select-programs" class="form-control"> <?php foreach($shs as $sh): ?>
                    <option <?php echo ($program == $sh['id'])?'selected':''; ?>
                        value="<?php echo $sh['id']; ?>"> <?php echo $sh['title']; ?> </option>
                    <?php endforeach; ?> </select>
            </div>
            <div class="">
                <label for="intYearLevel">By Year Level:</label>
                <select id="int-year-level" class="form-control select2">
                    <option <?php echo ($postyear == 0)?'selected':''; ?> value="0">All</option>
                    ...
                    <option <?php echo ($postyear == 6)?'selected':''; ?> value="6">6th</option>
                </select>
            </div>
        </form>
    </section>
    <div class="content">
        <div class="box box-solid box-default">
            <div class="box-header">
                ...
                <h3 class="box-title">SHS GWA Rank</h3>
                <div class="box-tools">
                </div>
            </div><!-- /.box-header -->
            <div class="box-body table-responsive">
                <table id="shs-gwa-rank-table" class="table table-hover">
                    <thead>
                        <tr>
                        </tr>
                    </thead>
