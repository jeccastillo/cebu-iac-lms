<aside class="right-side">
    <section class="content-header">
        <h1>
            ...
            <small>
                <button class="btn btn-app" id="ched_nstp_report_pdf" target="_blank" href="#"><i
                        class="fa fa-book"></i>Print PDF</button>
            </small>
            <small>
                <button class="btn btn-app" id="ched_nstp_report_excel" target="_blank" href="#"><i
    ...
    <div class="content">
        <div class="box box-solid box-default">
            <div class="box-header">
                ...
                <h3 class="box-title">NSTP Report</h3>
                <div class="box-tools">

                </div>
            </div><!-- /.box-header -->
            <div class="box-body table-responsive">
                <table id="nstp-report-table" class="table table-hover">
                    <thead>
                        <tr>
