        ...
        $(".cut-off-registration").click(function(e){
            ...
            showLoaderOnConfirm: true,
                preConfirm: (login) => {       
                    Swal.fire({
                        title: 'Cut Off Registration',                        
                        html:'Are you absolutely sure you want continue with cut off?<hr /><div class="form-group"><label>Enter Enlistment Cut-off Date</label></div><input type="date" class="form-control" autofocus></div>',
                        showCancelButton: true,                        
