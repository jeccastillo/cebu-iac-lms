...
class Registrar extends CI_Controller {
    ...
    public function available_subjects($id,$sem){
        ...
        $ret['data'] = $this->data_fetcher->getSubjectsAvailable($student['intCurriculumID'],$sem);
    ...
    public function add_subject_student(){
        ...
        $classlist_student = $this->db->get_where('tb_mas_classlist_student',array('intCSID'=>$post['subject_to_replace']))->first_row();
    ...
    public function shs_enrolled_by_grade_level_data($sem)
    {
        ...
        $data['sem'] = $sy;
        $data['enrollment'] = $ret;
        $data['no_grade_level'] = count($no_grade_level);
        $data['total_enrolled'] = $total_enrolled;
        $data['grade11_total'] = $grade11_total;
        $data['grade12_total'] = $grade12_total;
        $data['total_enrolled'] = $total_enrolled;
