...
class Registrar extends CI_Controller {
    ...
    public function add_subject_student(){
        ...
        $add_to = $this->db->get_where('tb_mas_classlist',array('intID',$post['section_to_add']))->first_row('array');
        ...
        foreach($records as $record){
            if($subject == $record['subjectID']){
                ...
                $classlist_data = $this->db->get_where('tb_mas_classlist',array('intID',$record['classlistID']))->first_row('array');
