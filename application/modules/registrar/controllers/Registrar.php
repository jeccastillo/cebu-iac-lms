...
class Registrar extends CI_Controller {
                ...
                if(!$this->data_fetcher->checkSubjectTaken($post['studentID'],$subject)) //if subject has not been taken
                {
                    ...
                    else // kapag wla pa section
                    {
                        ...
                        if(!is_array($cl)) //if $cl is not array
                        {
                            ...
                            $classlist['strSection'] = $program['strProgramCode']."-".$subject_data['intYearLevel']."-".$letter;
    ...
    function get_tuition_ajax()
    {
        ...
        $tuition = $this->data_fetcher->getTuitionSubjects($post['stype'],$this->data['unit_fee'],$this->data['misc_fee'],$this->data['lab_fee'],$this->data['athletic'],$this->data['id_fee'],$this->data['srf'],$this->data['sfdf'],$this->data['csg'],$post['scholarship'],$post['subjects_loaded']);
