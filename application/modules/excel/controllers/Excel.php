            ...
            if($reg && substr($user['strStudentNumber'], 0, 1) != 'T'){
                if($reg_status == 'Enrolled'){
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('AC'.$i, $deduction_type == 'scholarship' && $tuition_discount > 0 ? $tuition_discount : ($tuition['scholarship_total_assessment_rate_scholar'] > 0 ? $tuition['scholarship_total_assessment_rate_scholar'] : '') )
