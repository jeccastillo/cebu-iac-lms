            ...
            if($reg && substr($user['strStudentNumber'], 0, 1) != 'T'){
                if($reg_status == 'Enrolled'){
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('W'.$i, ($date_enrolled <= $sy->ar_report_date_generation && $deduction_type == 'scholarship') && $tuition_discount > 0 ? $tuition_discount : $assessment_discount_rate )
                        ->setCellValue('X'.$i, ($date_enrolled <= $sy->ar_report_date_generation && $deduction_type == 'scholarship') && $tuition['scholarship_tuition_fee_fixed'] > 0 ? $tuition['scholarship_tuition_fee_fixed'] : $assessment_discount_fixed)
