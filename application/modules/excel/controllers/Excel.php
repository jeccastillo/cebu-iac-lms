            ...
            if($reg && substr($user['strStudentNumber'], 0, 1) != 'T'){
                if($reg_status == 'Enrolled'){
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('AC'.$i, $deduction_type == 'scholarship' && $tuition_discount > 0 ? $tuition_discount : ($scholarship_total_assessment_rate_scholar > 0 ? $scholarship_total_assessment_rate_scholar : '') )
                        ...
                        ->setCellValue('AK'.$i, ($date_enrolled <= $sy->ar_report_date_generation) && $scholarship_total_assessment_rate_discount > 0 ? $scholarship_total_assessment_rate_discount : '')
