            ...
            if($reg && substr($user['strStudentNumber'], 0, 1) != 'T'){
                if(in_array($reg_status, ['Enrolled', 'Officially Withdrawn']) || ($reg_status =='LOA' && $reg['withdrawal_period'] == 'after')){
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('AC'.$i, $tuition_discount > 0 && $assessment_discount_rate_scholar > 0 ? $assessment_discount_rate_scholar : '')
                        ...
                        ->setCellValue('AK'.$i, $assessment_discount_rate_referrer > 0 ? $assessment_discount_rate_referrer : '')
