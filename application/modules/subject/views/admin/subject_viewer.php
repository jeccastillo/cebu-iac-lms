...
<section class="content-header">
                    <h1>
                        <small>
                                                  <a class="btn btn-app" href="<?php echo base_url() ?>subject/view_all_subjects" ><i class="ion ion-arrow-left-a"></i>Back</a> 
                            <a class="btn btn-app trash-subject2" rel="<?php echo $subjects['intID']; ?>" href="#"><i class="ion ion-android-close"></i> Delete</a>   
                            <a class="btn btn-app" href="<?php echo base_url()."subject/edit_subject/".$subjects['intID']; ?>"><i class="ion ion-edit"></i> Edit</a> 
                        </small>
...
<!--                        <th>Action</th>-->
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="<?php echo base_url().'unity/classlist_viewer/'.$class['intID']; ?>"><?php echo $class['strSection']; ?></a></td>
