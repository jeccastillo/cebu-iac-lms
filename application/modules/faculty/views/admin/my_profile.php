                        ...
                        <?php if(!empty($class['schedule'])): ?>
                            ...
                            <td>
                                ...
                                <?php
                                                ...
                                                ?>
                                                <input type="hidden" class="<?php echo $sched['strDay']; ?>" value="<?php echo date('gia',strtotime($sched['dteStart'])); ?>" href="<?php echo $hourdiff*2; ?>" rel="<?php echo $class['strCode']; ?> <?php echo $sched['strRoomCode']; ?> <?php echo $class['strSection']; ?>">
                                <?php endforeach; ?>
                            </td>
                            <?php else: ?>
                            <td></td>
...
<!--                    <td><?php echo $record['strFirstname']." ".$record['strLastname'];  ?></td>-->
    ...
    <div class="box box-primary">
        ...
        <form method="post" action="<?php echo base_url() ?>pdf/print_sched">   
            ...
            <input type="hidden" value="<?php echo $faculty['strLastname']."-".$faculty['strFirstname']."-".$faculty['intID']; ?>" name="studentInfo" id="studentInfo" />
