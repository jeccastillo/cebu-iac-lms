...
<section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Report of Grades</li>
                    </ol>
                </section>
<div class="content">
    <div class="span10 box box-primary">
        <div class="box-header">
                <h3 class="box-title">Get Report of Grades</h3>
        ...
        <div class="box box-solid">
            <div class="box-body">
             ...
             <form id="advise-student" action="<?php echo base_url(); ?>unity/student_viewer/0/<?php echo $active_sem['intID']; ?>/tab_2" method="post" role="form">
                 <p>Search Student</p>
                 <div class="row">
                     <div class="col-sm-6">
