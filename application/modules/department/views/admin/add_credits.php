...
<section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>Credits</a></li>
...
<div class="content">
    <div class="span10 box box-primary">
        <div class="box-header">
                <h3 class="box-title">Advise Credited Subject</h3>
        ...
        <div class="box box-solid">
            <div class="box-body">
             ...
             <form id="advise-student" action="<?php echo base_url(); ?>department/crediting" method="post" role="form">
                 <p>Search Student</p>
                 <div class="row">
                     <div class="col-sm-6">
