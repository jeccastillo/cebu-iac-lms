...
<div class="content">
    <div class="span10 box box-primary">
        <div class="box-header">
                <h3 class="box-title">Curriculum Assessment</h3>
        ...
        <div class="box box-solid">
            <div class="box-body">
             ...
             <form id="advise-student" action="<?php echo base_url(); ?>unity/student_viewer/0/<?php echo $active_sem['intID']; ?>/tab_3" method="post" role="form">
                 <p>Search Student</p>
                 <div class="row">
                     <div class="col-sm-6">
