...
<script type="text/javascript">
    ...
    $('#health_record_excel').click(function(e){
        ...
        var url = base_url + 'excel/guidance_record/0';
    ...
    var table = $('#users_table').DataTable( {
            ...
            "ordering": false,
            "autoWidth": false,
            "sAjaxSource": "<?php echo base_url(); ?>datatables/data_tables_ajax/tb_mas_guidance_records",
            "aoColumnDefs":[
                {
                    "aTargets":[9],
                    "mData": null,
                    "bSortable":false,
                    "mRender": function (data,type,row,meta) { return '<?php echo $d_open; ?><li><a target="_blank" href="<?php echo base_url(); ?>clinic/view_record/'+row[1]+'/'+row[4]+'">View Patient Records</a></li>'                                                                
