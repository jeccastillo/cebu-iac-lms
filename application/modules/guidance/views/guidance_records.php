        ...
        <div class="modal-content container">
            <form method="post" @submit.prevent="submitHealthRecord">
                <div class="modal-header">        
                    ...
                    <h4 class="modal-title">Add Guidance Record</h4>
                </div>
...
new Vue({
    ...
    mounted() {
        ...
        if(this.id != 0){            
            ...
            axios.get(this.base_url + 'guidance/guidance_records_data/'+this.id)
                .then((data) => {                                      
    ...
    methods: {      
        ...
        downloadHealthRecord: function(id){
            var url = this.base_url + 'excel/guidance_record/' + id;
