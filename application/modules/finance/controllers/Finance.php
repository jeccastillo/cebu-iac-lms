...
class Finance extends CI_Controller {
    ...
    public function finance_invoice_report_data($report_date_start, $report_date_end = null)
    {
        ...
        $results = $this->db
                    ...
                    ->where(array('status !=' => 'expired','status !=' => 'Transaction Failed','status !=' => 'cancel','status !=' => 'declined','status !=' => 'error', 'DATE_FORMAT(or_date, "%Y-%m-%d") >=' => $report_date_start, 'DATE_FORMAT(or_date, "%Y-%m-%d") <=' => $report_date_end, 'invoice_number !=' => null, 'deleted_at !=' => null))
