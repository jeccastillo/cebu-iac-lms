...
class Finance extends CI_Controller {
    ...
    public function finance_invoice_report_data($report_date_start, $report_date_end = null)
    {
        ...
        $results = $this->db
                    ...
                    ->where(array('status !=' => 'expired','status !=' => 'Transaction Failed','status !=' => 'cancel','status !=' => 'declined','status !=' => 'error', 'or_date >=' => $report_date_start, 'or_date <=' => $report_date_end, 'invoice_number !=' => null, 'deleted_at !=' => null))
