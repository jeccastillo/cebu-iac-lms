                        ...
                        <div class="box-body">
                            <div class="row">
                                <form @submit.prevent="submitManualPayment" method="post">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select required @change="selectDescription" class="form-control"
                                                ...
                                                <option
                                                    v-if="application_payment && application_payment.status == 'Paid'"
                                                    value="Reservation Payment">Reservation</option>
                                    ...
                                    <div class="col-sm-12">
                                        <button :disabled="!request.or_number" class="btn btn-primary btn-lg"
                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                ...
                                <tr v-for="refunded in refunded_payments">
                                    ...
                                    <td>
                                        <button v-if="!refunded.or_number" data-toggle="modal"
                                            @click="or_update.id = application_payment.id;" data-target="#myModal"
                                            class="btn btn-primary">
                                            Update OR
                                        </button>
                                        <button v-if="refunded.or_number" @click="printOR(application_payment)"
                                            class="btn btn-primary">
                                            Print OR
                                        </button>
                                    </td>
                                ...
                                <tr v-if="application_payment">
                                    ...
                                    <td><a href="#"
                                            @click.prevent.stop="cashierDetails(application_payment.cashier_id)">{{ application_payment.cashier_id }}</a>
                                    </td>
                                ...
                                <tr v-if="reservation_payment">
                                    ...
                                    <td><a href="#"
                                            @click.prevent.stop="cashierDetails(reservation_payment.cashier_id)">{{ reservation_payment.cashier_id }}</a>
                                    </td>
                                    ...
                                    <td>
                                        <button v-if="!reservation_payment.or_number" data-toggle="modal"
                                            @click="or_update.id = reservation_payment.id;" data-target="#myModal"
                                            class="btn btn-primary">
                                            Update OR
                                        </button>
...
new Vue({
            ...
            .then((data) => {
                ...
                axios.get(base_url + 'finance/manualPayData/' + this.slug)
                    .then((data) => {
                        ...
                        this.applicant_id = "A" + data.data.sem_year + "-" + String(this.student.id)
                            .padStart(4, '0');
                        if (this.cashier) {
    ...
    methods: {
                                ...
                                axios.post(base_url + 'finance/next_or', formdata, {
                                    ...
                                    .then(function(data) {
                                        if (data.data.send_notif) {
                                            let url = api_url +
                                                'registrar/send_notif_enrolled/' + this
                                                .student_data.slug;
                                            let payload = {
        ...
        submitManualPayment: function() {
            ...
            this.loader_spinner = true;
            if (this.request.description == "Reservation Payment" && this.reservation_payment && this
                .reservation_payment.status == "Paid")
                Swal.fire({
                    title: "Failed",
            ...
            else if (this.request.description == "Application Payment" && this.application_payment && this
                .application_payment.status == "Paid")
                Swal.fire({
                    title: "Failed",
