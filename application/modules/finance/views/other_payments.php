<aside class="right-side">
    <div id="vue-container">
        <section class="content-header">
            <small>
                <a class="btn btn-app" :href="base_url + 'finance/payments/0/1'"><i
                        class="ion ion-arrow-left-a"></i>Non-student Payments</a>
            </small>
            <h1> Add Non-Student Payment </h1>
        </section>
        <hr />
        <div class="content">
            <div class="row">
...
new Vue({
    ...
    mounted() {
        ...
        axios.get(base_url + 'finance/other_payment_data/').then((data) => {
