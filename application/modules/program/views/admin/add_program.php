...
<div class="content">
    <div class="span10 box box-primary">
        <div class="box-header">
            ...
            <form id="validate-program" action="<?php echo base_url(); ?>program/submit_program" method="post" role="form">
                <div class="box-body">
                         <div class="form-group col-xs-6">
                            <label for="strProgramCode">Program Code</label>
                            <input type="text" name="strProgramCode" class="form-control" id="strProgramCode" placeholder="Enter Code">
                        </div>
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="form-group col-xs-6">
                            ...
                            <input type="text" name="short_name" class="form-control" id="short_name" placeholder="Enter Short Name">
                        </div>
