...
<script type="text/javascript">
        ...
        if(objects.length > 0 ){
            ...
            $.ajax({
                ...
                'success':function(ret){
                        ...
                        document.location = "<?php echo base_url(); ?>messages/sent_messages";
                    }
                });
    ...
    $('#messages_table').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo base_url(); ?>datatables/sentItemsData",
            "aoColumnDefs":[
                {
                    "aTargets":[5],
                    "mData": null,
                    "bSortable":false,
                    "mRender": function (data,type,row,meta) { return '<?php echo dropdown_menu_open(); ?><li><a href="<?php echo base_url(); ?>messages/view_message/'+row[0]+'">Read</a></li><?php echo dropdown_menu_close(); ?>'; }
                },
                {
                    "aTargets":[0],
                    "bVisible": false 
