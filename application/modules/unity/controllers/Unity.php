...
class Unity extends CI_Controller {
    ...
    function get_tuition_ajax(){
        ...
        $data['tuition'] = $this->data_fetcher->getTuitionSubjects($post['stype'],0,0,$post['subjects_loaded'],$post['studentID'],$post['type_of_class'],$sem['intID']);
        $ret['tuition'] = $this->load->view('tuition/tuition_view', $data, true);                
    ...
    public function student_records_data($id){
        ...
        $registrations = $this->db->select('tb_mas_registration.*,tb_mas_sy.enumSem,tb_mas_sy.strYearStart,tb_mas_sy.strYearEnd, tb_mas_sy.term_label')
        ...
        foreach($curicculum as $cs){
            ...
            $this->db->select('floatFinalGrade,strRemarks,tb_mas_subjects.strUnits,tb_mas_subjects.include_gwa')
                     ...
                     ->where(array('tb_mas_classlist.intSubjectID'=>$cs['intSubjectID'],'tb_mas_classlist_student.intStudentID'=>$data['student']['intID'],'tb_mas_classlist_student.strRemarks'=>'Passed'))
        ...
        foreach($registrations as $reg){
            ...
            foreach($records as $record){
                ...
                if($record['intFinalized'] == 2 && $record['include_gwa'] && ($record['strRemarks'] == "Passed" || $record['strRemarks'] == "Failed")){
