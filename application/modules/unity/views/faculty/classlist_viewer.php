                            ...
                            foreach($students as $student):
                                ...
                                <?php endif; ?>
                                    ...
                                    <?php if($classlist['is_numerical']): ?>
                                        ...
                                        <td>
                                            <select <?php echo (($classlist['intFinalized'] != 1 || $active_midterm_grading['enumMGradingPeriod'] != 'active'))?'disabled':''; ?> id="inputMidtermID-<?php echo $student['intCSID']; ?>"class="midtermInput grade-input form-control" rel="<?php echo $student['intCSID'] ?>" value="<?php echo $student['floatMidtermGrade']; ?>">                              
