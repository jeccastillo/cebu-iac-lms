        ...
        <section class="content-header">
            <h1>
                ...
                <small>
                    ...
                    <a class="btn btn-app" v-else-if="(is_super_admin || is_registrar)"
                        ...
                        <tbody>
                            <tr :style="sid == student.intID?'background-color:#ccc;':''"
                                ...
                                <td><a :href="base_url + 'unity/student_viewer/' + student.intID">{{ student.strLastname.toUpperCase() +' '+student.strFirstname.toUpperCase() }}
                                        <span
                                            v-if="student.strMiddlename">{{ ' '+student.strMiddlename.toUpperCase() }}</span>
                                    </a></td>
                                ...
                                <td v-if="student.registered">
                                    <span
                                        ...
                                        {{ (student.floatMidtermGrade && student.floatMidtermGrade != 50)?student.floatMidtermGrade:"NGS1" }}
                                    </span>
                                    ...
                                    <select v-else @change="updateGrade($event,'midterm',student.intCSID)"
                                        ...
                                        <option v-for="grading_item in grading_items_midterm"
                                            :selected="student.floatMidtermGrade == grading_item.value"
                            ...
                            <form v-if="classlist.intFinalized == 0 && (is_super_admin || is_registrar)" method="post"
                                ...
                                <div class="col-sm-4">
                                    <select required v-model="transfer_to" class="form-control">
                                        <option v-for="c in cl" :value="c.intID">
                                            {{ c.strCode + " - " +  c.strClassName + " " + c.year + c.strSection + " " + (c.sub_section?c.sub_section:'') }}
                                        </option>
                                    </select>
                                </div>
                            </form>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6" class="form-control">
                                ...
                                <input type="text" class="form-control" name="submitted_by"
                                    :value="classlist.strFirstname.toUpperCase()+' '+classlist.strLastname.toUpperCase()">
                            </div>
                            <div class="form-group col-sm-6" class="form-control">
                                <label>Date</label>
