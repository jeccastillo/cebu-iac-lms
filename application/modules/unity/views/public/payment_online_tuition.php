<div id="registration-container">
    <div class="container">
        <div class="content">
            <h3>Name :{{ student.strFirstname }} {{ student.strLastname }} <br /> Stud No
                :{{ student.strStudentNumber }}
            </h3>
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#tab1" data-toggle="tab"> PAY ONLINE </a>
                    </li>
                    <li>
                        <a href="#tab2" data-toggle="tab"> ASSESSMENT OF FEES </a>
                    </li>
                    <li>
                        <a href="#tab3" data-toggle="tab"> MY PAYMENTS </a>
                    </li>
                </ul>
                <div class="tab-content">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="d-flex flex-wrap"
                                                ...
                                                <div v-for="t in payment_modes_nonbanks"
                                                    ...
                                                    style="display:flex; align-itenms:center;">
                                                    <img class="img-fluid d-block mx-auto"
                                                        width="51px" :src="t.image_url" alt="">
                                                </div>
                                            </div>
                                            <hr />
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Gateway Fee <span
                                                                    ...
                                                                    or Php 25.00 whichever is higher
                                                                    )</span> </td>
                                            ...
                                            <table class="table table-striped" v-else>
                                                <tr>
                                                    <td><input
                                                            ...
                                                            type="checkbox" :value="down_payment"
                                                ...
                                                <tr v-for="(inst,ctr) in installments">
                                                    <td><input v-if="inst > 0" type="checkbox"
                                                            :value="inst"
                                                            @change="updatePayment($event)"
                                                            class="form-check-input"></input></td>
                                ...
                                <div class="box box-solid">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                <th colspan="6"> Other Payments: </th>
                                            </tr>
                                            ...
                                            <tr>
                                                <th colspan="6"> Tuition Payments: </th>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="text-green" colspan="5"> amount paid:
                                                    P{{ amount_paid_formatted }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-green" colspan="5"> remaining
                    ...
                    <form ref="bdo_form" action="https://secureacceptance.cybersource.com/pay"
                        method="post">
                        <input type="hidden" v-for="(value, name, index) in request_bdo"
...
new Vue({
    ...
    methods: {
        loadData: function() {
            axios.get(this.base_url + 'unity/online_payment_data/' + this.id + '/' +
                ...
                if (data.data.success) {
                    ...
                    this.installment_dates.push(data.data.active_sem
                        .installment5);
                    if (this.payment_type == "partial") this.remaining_amount =
                        data.data.tuition_data.total_installment;
        ...
        updatePayment: function(event) {
            if (event.target.checked) this.item_details.price += parseFloat(event.target
                .value);
            else this.item_details.price -= parseFloat(event.target.value);
            if (this.selected_mode_of_payment.id) this.selectPayment(this
                .selected_mode_of_payment);
        },
        computePayment: function(event) {
            if (this.registration.enumStudentType == "new") {
                ...
                if (this.payment_type == "full") {
                    ...
                    console.log(this.this.tuition_data.installment_fee + ' @ ');
                    console.log(this.this.tuition_data.installment_fee * 5 + ' @ ');
                    for (i = 0; i < 5; i++) {
                        if (this.tuition_data.installment_fee > temp) {
                            val = this.tuition_data.installment_fee - temp;
                            val = val.toFixed(2);
                    ...
                    this.item_details.price = 0;
                    for (i = 0; i < 5; i++) this.installments.push(this.tuition_data
                        .installment_fee);
                }
                axios.get(api_url + 'admissions/student-info/' + this.slug).then((
                    data) => {
                        this.student_api_data = data.data.data;
                        Swal.close();
                        $(function() {
