...
<section class="content-header">
                    <h1>
                        ...
                        <small>
                            ...
                            <?php endif; ?>
                            <?php if($status == 0): ?>
                                <a class="btn btn-app" href="<?php echo base_url()."unity/view_classlist_archive_admin/".$selected_ay."/".$program."/".$dissolved."/".$has_faculty."/1" ?>" ><i class="fa fa-user"></i> No Grades Submitted</a>
                                <a class="btn btn-app" href="<?php echo base_url()."unity/view_classlist_archive_admin/".$selected_ay."/".$program."/".$dissolved."/".$has_faculty."/2" ?>" ><i class="fa fa-user"></i> Midterms Grade Submitted</a>
                                <a class="btn btn-app" href="<?php echo base_url()."unity/view_classlist_archive_admin/".$selected_ay."/".$program."/".$dissolved."/".$has_faculty."/3" ?>" ><i class="fa fa-user"></i> Final Grade Submitted</a>                                                                                                
                            <?php elseif($status == 1): ?>                                                                
                                <a class="btn btn-app" href="<?php echo base_url()."unity/view_classlist_archive_admin/".$selected_ay."/".$program."/".$dissolved."/".$has_faculty."/1" ?>" ><i class="fa fa-user"></i> All Statuses</a>
                                <a class="btn btn-app" href="<?php echo base_url()."unity/view_classlist_archive_admin/".$selected_ay."/".$program."/".$dissolved."/".$has_faculty."/2" ?>" ><i class="fa fa-user"></i> Midterms Grade Submitted</a>
                                <a class="btn btn-app" href="<?php echo base_url()."unity/view_classlist_archive_admin/".$selected_ay."/".$program."/".$dissolved."/".$has_faculty."/3" ?>" ><i class="fa fa-user"></i> Final Grade Submitted</a>                                                                
                            <?php elseif($status == 2): ?>                                                                
                                <a class="btn btn-app" href="<?php echo base_url()."unity/view_classlist_archive_admin/".$selected_ay."/".$program."/".$dissolved."/".$has_faculty."/1" ?>" ><i class="fa fa-user"></i> All Statuses</a>
