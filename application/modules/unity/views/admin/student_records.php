<aside class="right-side" id="registration-container">
    ...
    <div class="content">
            ...
            <div class="col-sm-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_6" data-toggle="tab">Not Registered Term</a></li>
                    </ul>
                    <div class="tab-content">
                                ...
                                <div class="box-header">
                                    <div class="row">
                                        <div class="col-sm-3">School Year: <span
                                                style="font-weight:400;">{{ term.reg.strYearStart + "-" + term.reg.strYearEnd }}</span>
                                        </div>
                                        <div class="col-sm-3">Term: <span
                                                style="font-weight:400;">{{term.reg.enumSem + " " + term.reg.term_label}}</span>
                                        </div>
                                        <div v-if="term.reg.intROG" class="col-sm-3">Enrollment
                                            Status: {{ term.reg.enrollment_status }}</div>
                                        <div v-else class="col-sm-3">Enrollment Status:</div>
                                        <div class="col-sm-3">Course: <span
                                                style="font-weight:400;">{{ term.reg.strProgramCode }}</span>
                                        </div>
                                    </div>
                                    <h5></h5>
                                </div>
                            ...
                            <div class="box box-success">
                                <div class="box-footer">
                                    <div class="row" style="font-weight:bold;">
                                        <div class="col-sm-3 text-right"> Actual Total Units Earned:
                                        </div>
                                        <div class="col-sm-3">
                                            {{ units }}
                                        </div>
                                        <div class="col-sm-3 text-right"> CGWA </div>
                                        <div class="col-sm-3">
                                            {{ gwa }}
                                        </div>
                                    </div>
                                    <div class="row" style="font-weight:bold;">
                                        <div class="col-sm-3 text-right"> Academic Units: </div>
                                        <div class="col-sm-3">
                                            {{ curriculum_units }}
                                        </div>
                                        <div class="col-sm-3 text-right"> Non Academic Units </div>
                                        <div class="col-sm-3">
                                            {{ curriculum_units_na }}
                                        </div>
                                    </div>
                                    <div class="row" style="font-weight:bold;">
                                        <div class="col-sm-3 text-right"> Credited Transferee Units:
                                        </div>
                                        <div class="col-sm-3">
                                            {{ credited_units }}
                                        </div>
                        ...
                        <div class="tab-pane" id="tab_2">
                                    ...
                                    <div v-for="record in curriculum_subjects">
                                        <table v-for="term in record"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th colspan="5">
                                                        {{ stringifyNumber(term.year) + ' Year ' + stringifyNumber(term.sem) + ' Term' }}
                                                    </th>
                                                </tr>
                                                <tr>
                                            ...
                                            <tbody>
                                                <template
                                                    ...
                                                    <tr v-if="item.type == 'combined'"
                                                        ...
                                                        <td>Combined</td>
                                                        <td>{{ getTotalUnitsEarnedCurriculum(term, item.data.intSubjectID) }}
                                                        </td>
                                                    </tr>
                                                    <tr v-else
                                                        :style="(item.data.rec || item.data.equivalent)?'color:'+item.data.rec.bg+';':''"
                                                        style="font-size: 13px;">
                                                        <td>{{ item.data.strCode }}</td>
                                                        <td>{{ item.data.strDescription }}</td>
                                                        <td v-if="item.data.equivalent">
                                                            {{ item.data.equivalent.grade }}
                                                        </td>
                                                        <td v-else>
                                                            {{ item.data.rec?item.data.rec.floatFinalGrade:'---' }}
                                                        </td>
                                                        <td v-if="item.data.equivalent">Credited
                                                            from:
                                                            {{ item.data.equivalent.course_code }}
                                                            School:
                                                            {{ item.data.equivalent.completion }}
                                                        </td>
                                                        <td v-else>
                                                            {{ item.data.rec?item.data.rec.strRemarks:'---' }}
                                                        </td>
                                                        <td v-if="item.data.equivalent">
                            ...
                            <div class="box box-success">
                                <div class="box-footer">
                                    <div class="row" style="font-weight:bold;">
                                        <div class="col-sm-2 text-right"> Total Units Earned: </div>
                                        <div class="col-sm-1">
                                            {{ assessment_units }}
                                        </div>
                                        <div class="col-sm-1 text-right"> GWA: </div>
                                        <div class="col-sm-1">
                                            {{ assessment_gwa }}
                                        </div>
                                        <div class="col-sm-2 text-right"> Total in Curriculum:
                                        </div>
                                        <div class="col-sm-1">
                                            {{ curriculum_units }}
                                        </div>
                                        <div class="col-sm-1 text-right"> Units Left: </div>
                                        <div class="col-sm-1">
                                            {{ units_left }}
                                        </div>
                                        <div class="col-sm-1 text-right"> Credited Transferee Units:
                                        </div>
                                        <div class="col-sm-1">
                                            {{ credited_units }}
                                        </div>
                        ...
                        <div class="tab-pane" id="tab_3">
                            <div v-for="term in credited_subjects" class="box box-success">
                                <div class="box-header">
                                    <h4>{{ term.other_data.school + " " + term.other_data.school_year + ", " + term.other_data.term }}
                                    </h4>
                                </div>
                                <div class="box-body">
                                    <table class="table table-condensed table-bordered">
                                    ...
                                    <table class="table table-condensed table-bordered">
                                        ...
                                        <tbody>
                                            <tr v-for="item in generated_tor"
                                                ...
                                                <td>{{ item.signatory_label ? item.signatory_label : 'Registrar' }}
                                                </td>
        ...
        <div class="modal fade" id="printTranscript" role="dialog">
            <form target="_blank" ref="generate_tor" @submit.prevent="printTOR" method="post"
                :action="base_url + 'pdf/generate_tor'" class="modal-dialog modal-lg">
                <!-- Modal content-->
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input required name="registrar" v-model="tor.registrar" type="text"
                                    class="form-control">
                            </div>
                            <div class="form-group col-sm-6">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <textarea required v-model="add_credits.descriptive_title"
                                    class="form-control"></textarea>
                            </div>
                            <div class="form-group col-sm-6">
                                <label>Units to credit *</label>
                                <input required v-model="add_credits.units" type="number" step="0.5"
                                    class="form-control">
                            </div>
                            <div class="form-group col-sm-6">
                                <label>Grade *</label>
        ...
        <div class="modal fade" id="editCreditSubjects" role="dialog">
            <form ref="edit_credit_subjects" @submit.prevent="updateCredited" method="post"
                class="modal-dialog modal-lg">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <label>Descriptive Title *</label>
                                <textarea required v-model="edit_credits.descriptive_title"
                                    class="form-control"></textarea>
                            </div>
                            <div class="form-group col-sm-6">
                                <label>Units *</label>
