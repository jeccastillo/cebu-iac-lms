                            ...
                            <div class="box-body">
                                <div v-for="record in curriculum_subjects">
                                    <table v-for="term in record" class="table table-condensed table-bordered">
                                        ...
                                        <tbody>                                          
                                            <tr :style="{(item.rec)?'background-color:'+item.rec.bg+';color:#f2f2f2':'',(item.equivalent)?'background-color:#009900;color:#f2f2f2':''}" v-for="item in term.records" style="font-size: 13px;">                                                
                                                <td>{{ item.strCode }}</td>
