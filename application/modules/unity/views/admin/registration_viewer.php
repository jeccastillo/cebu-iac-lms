    ...
    <section class="content-header">
        <h1>
            <small>
                ...
                <a target="_blank" v-if="registration" class="btn btn-app"
                ...
                <div class="box box-widget widget-user-2">
                    ...
                    <div class="widget-user-header bg-red">
                        ...
                        <h3 class="widget-user-username"
                            style="text-transform:capitalize;margin-left:0;font-size:1.3em;">{{ student.strLastname }},
                            {{ student.strFirstname }} {{ student.strMiddlename }}</h3>
                        <h5 class="widget-user-desc" style="margin-left:0;">{{ student.strProgramDescription }}
                            {{ (student.strMajor != 'None')?'Major in '+student.strMajor:'' }}</h5>
                    </div>
                    <div class="box-footer no-padding">
                        <ul class="nav nav-stacked">
                            ...
                            <li v-if="registration"><a style="font-size:13px;" href="#">Registration Status <span
                                        class="pull-right">{{ reg_status }}</span></a></li>
                            <li v-if="registration"><a style="font-size:13px;" href="#">Class Type <span
                                        class="pull-right">{{ registration.type_of_class }}</span></a></li>
                            <li>
                            ...
                            <li v-if="registration"><a style="font-size:13px;" href="#">Scholarship Type <span
                                        class="pull-right">{{ registration.scholarshipName }}</span></a></li>
                                ...
                                <div class="box-body">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr v-if="application_payment">
                                            ...
                                            <td>
                                                <button
                                                    v-if="!application_payment.or_number && application_payment.status == 'Paid'"
                                                    data-toggle="modal"
                                                ...
                                                <button v-if="application_payment.or_number"
                                                    @click="printOR(application_payment)" class="btn btn-primary">
                                                    Print OR
                                                </button>
                                            </td>
                                        </tr>
                                        <tr v-if="reservation_payment">
                                            ...
                                            <td>
                                                <button
                                                    v-if="!reservation_payment.or_number && reservation_payment.status == 'Paid'"
                                                    data-toggle="modal"
                                                ...
                                                <button v-if="reservation_payment.or_number"
                                                    @click="printOR(reservation_payment)" class="btn btn-primary">
                                                    Print OR
                                                </button>
                                            </td>
                                        </tr>
                                        ...
                                        <tr v-for="payment in other_payments">
                                            ...
                                            <td>
                                                <button v-if="!payment.or_number && payment.status == 'Paid'"
                                                    data-toggle="modal"
                                                ...
                                                <button
                                                    v-if="payment.status == 'Pending' && payment.mode.name == 'MANUAL'"
                                                    class="btn btn-primary" @click="setToPaid(payment.id)">Set to
                                                    paid</button>
                                                <button
                                                    v-if="payment.status == 'Pending' && payment.mode.name == 'MANUAL'"
                                                    class="btn btn-danger"
                                                    @click="deletePayment(payment.id)">Delete</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th colspan="8">
                                        ...
                                        <tr v-for="payment in payments">
                                            ...
                                            <td>
                                                ...
                                                <button
                                                    v-if="(payment.status == 'Pending' && payment.mode.name == 'MANUAL') && cashier"
                                                    class="btn btn-primary" @click="setToPaid(payment.id)">Set to
                                                    paid</button>
                                                <button
                                                    v-if="(payment.status == 'Pending' && payment.mode.name == 'MANUAL')  && cashier"
                                            ...
                                            <form @submit.prevent="submitManualPayment" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <select @change="selectDescription" class="form-control"
                                                        ...
                                                        <option value="Tuition Down Payment">Tuition Down Payment
                                                        </option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" :disabled="description != 'Other'" required
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        :disabled="description != 'Other' && description != 'Tuition Specific' && description != 'Tuition Down Payment'"
                                                ...
                                                <button class="btn btn-primary btn-lg" :disabled="!request.or_number"
...
new Vue({
            ...
            axios.get(this.base_url + 'unity/registration_viewer_data/' + this.id + '/' + this.sem)
                .then((data) => {
                    if (data.data.success) {
                        ...
                        this.or_print.student_name = this.request.strFirstname + ' ' + this.request
                            .strLastname;
                            ...
                            .then((data) => {
                                ...
                                for (i in this.payments) {
                                    if (this.payments[i].status == "Paid") {
                                        if (this.payments[i].description == "Tuition Partial" || this
                                            .payments[i].description == "Tuition Down Payment")
                                ...
                                for (i in this.payments) {
                                    if (this.payments[i].status == "Paid") {
                                        this.remaining_amount = this.remaining_amount - this.payments[i]
                                            .subtotal_order;
                                        this.amount_paid = this.amount_paid + this.payments[i]
                                            .subtotal_order;
                                    }
                                }
    ...
    methods: {
                    ...
                    return axios.post(url, this.or_update, {
                        ...
                        .then(data => {
                            ...
                            if (data.data.success) {
                                ...
                                formdata.append('registration_id', this.registration
                                    .intRegistrationID);
                                axios.post(base_url + 'finance/next_or', formdata, {
                                    ...
                                    .then(function(data) {
                                        if (data.data.send_notif) {
                                            let url = api_url +
                                                'registrar/send_notif_enrolled/' + slug;
                                            let payload = {
        ...
        printOR: function(payment) {
            ...
            this.or_print.student_name = this.request.last_name + ", " + this.request.first_name + ", " +
            ...
            if (this.description != 'Other') {
                ...
                switch (this.description) {
                    ...
                    case 'Tuition Partial':
                        this.amount_to_pay = (this.tuition_data.installment_fee > this.remaining_amount) ?
                            this.remaining_amount : this.tuition_data.installment_fee;
                        break;
                    case 'Tuition Down Payment':
                        this.amount_to_pay = (this.tuition_data.down_payment <= this.amount_paid) ? 0 : (
                            this.tuition_data.down_payment - this.amount_paid);
                        break;
                }
            } else {
