                                ...
                                <div class="box-body">   
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr v-if="application_payment">
                                            ...
                                            <td>                                                
                                                <button v-if="!application_payment.or_number && application_payment.status == 'Paid' && cashier && application_payment.status != 'Void'" data-toggle="modal"                                                
                                                ...
                                                <button v-if="application_payment.status == 'Paid' && application_payment.status != 'Void' &&  application_payment.mode.name == 'Onsite Payment' && cashier && finance_manager_privilages" data-toggle="modal" data-target="#voidPaymentModal" class="btn btn-primary" @click="setToVoid(application_payment.id)">Void/Cancel</button>
                                            </td>
                                        </tr>                                        
                                        <tr v-for="payment in other_payments">
                                            ...
                                            <td>
                                                ...
                                                <button v-if="payment.status == 'Paid' && application_payment.status != 'Void' && payment.mode.name == 'Onsite Payment' && cashier && finance_manager_privilages"  class="btn btn-primary" data-toggle="modal" data-target="#voidPaymentModal" @click="setToVoid(payment.id)">Void/Cancel</button>
                                        ...
                                        <tr v-if="reservation_payments" v-for="reservation_payment in reservation_payments">
                                            ...
                                            <td>                                                
                                                ...
                                                <button v-if="reservation_payment.status == 'Paid' && application_payment.status != 'Void' && reservation_payment.mode.name == 'Onsite Payment' && cashier && finance_manager_privilages" data-toggle="modal" data-target="#voidPaymentModal"  class="btn btn-primary" @click="setToVoid(reservation_payment.id)">Void/Cancel</button>
                                            </td>
                                        </tr> 
                                        <tr v-for="payment in payments">                                            
                                            ...
                                            <td>
                                                ...
                                                <button v-if="payment.mode && payment.status == 'Paid' && application_payment.status != 'Void' && payment.mode.name == 'Onsite Payment' && cashier && finance_manager_privilages" data-toggle="modal" data-target="#voidPaymentModal"  class="btn btn-primary" @click="setToVoid(payment.id)">Void/Cancel</button>
