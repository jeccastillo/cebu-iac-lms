<aside class="right-side">
    <div id="student-viewer-container">
        <section class="content-header">
            <h1>
                ...
                <div class="box-tools pull-right" style="width: 100%; max-width: 600px;">
                    ...
                    <select id="select-sem" v-model="sem_student" class="form-control" style="width: 100%">
                    ...
                    <div v-if="student" class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-red">
                            ...
                            <h3 class="widget-user-username"
                                ...
                                {{ student.strLastname.toUpperCase() }},
                                {{ student.strFirstname.toUpperCase() }}
                        ...
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                ...
                                <li><a href="#" style="font-size:13px;">Status <span
                                ...
                                <li><a style="font-size:13px;" href="#">Registration Status <span
                                            class="pull-right">{{ reg_status }}</span></a></li>
                                <li><a @click.prevent="resetStatus()" href="#"><i
                                            class="ion ion-android-close"></i> Reset Status</a>
                                </li>
                                <li>
                                ...
                                <li v-if="registration"><a style="font-size:13px;"
                                        href="#">Scholarship <span
                                            class="pull-right">{{ scholarship.name }}</span></a>
                                </li>
                                <li v-if="registration"><a style="font-size:13px;" href="#">Discount
                                        <span class="pull-right">{{ discount.name }}</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li v-if="enlistment" :class="[(tab == 'tab_4') ? 'active' : '']"><a
                                    href="#tab_4" data-toggle="tab">Advising</a></li>
                        ...
                        <div class="tab-content">
                            <div :class="[(tab == 'tab_1') ? 'active' : '']" class="tab-pane"
                                id="tab_1">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <p><strong>Student Number:
                                                    </strong>{{ student.strStudentNumber.replace(/-/g, '') }}
                                                </p>
                                                <!-- <p><strong>Learner Reference Number(LRN): </strong>{{ student.strLRN'] }}</p> -->
                                                <div v-if="registration">
                                                    <label>Block Section</label>
                                                    <select @change="updateBlock($event)"
                                                        id="block_section" name="block_section"
                                                        class="form-control"
                                                        v-model="registration.block_section">
                                                        <option v-for="block in block_sections"
                                                            :value="block.intID">{{ block.name }}
                                                        </option>
                                                    </select>
                                                </div>
                                                <p><strong>Gender: </strong>{{ student.enumGender }}
                                                </p>
                                                <p><strong>Address:
                                                    </strong>{{ student.strAddress }}</p>
                                                <p><strong>Contact:
                                                    </strong>{{ student.strMobileNumber }}</p>
                                                <!-- <p><strong>Institutional Email: </strong>{{ student.strGSuiteEmail' }}</p>   -->
                                                <p><strong>Personal Email:
                                                    </strong>{{ student.strEmail }}</p>
                                                <p><strong>Birthdate:
                                                    </strong>{{ student.dteBirthDate }}</p>
                                                <p><strong>Date Created:
                                                    </strong>{{ student.dteCreated }}</p>
                                                <p><strong>Admission Status:
                                                    </strong>{{ applicant_data.tos }}</p>
                                                ...
                                                <div v-if="registration">
                                                    <p><strong>Enrollment Type: </strong>
                                                        <select class="form-control"
                                                            @change="updateStudentType($event)"
                                                            ...
                                                            <option value="2nd Degree">2nd Degree
                                                            </option>
                                                            <option value="2nd Degree iAC">2nd
                                                                Degree iAC</option>
                                                            <option value="returning">Returnee
                                                            </option>
                                                            <option value="transferee">Transferee
                                                            </option>
                                                            <option value="acadRes">Academic
                                                                Residency</option>
                                                        </select>
                                                    </p>
                                                    <p><strong>Year Level: </strong>
                                                        <select class="form-control"
                                                            @change="updateStudentYearLevel($event)"
                                                    ...
                                                    <p><strong>Academic Status: </strong>
                                                        <select class="form-control"
                                                            @change="updateAcademicStatus($event)"
                                                    ...
                                                    <p v-if="user_level == 2"><strong>Enrollment
                                                            Status: </strong>
                                                        <select class="form-control"
                                                            @change="updateEnrollmentStatus($event)"
                                                    ...
                                                    <p v-if="user_level == 2"><strong>Withdrawal
                                                            Period (for students that withdrawn for
                                                            the term): </strong>
                                                        <select class="form-control"
                                                            @change="updateWithdrawalPeriod($event)"
                                                    ...
                                                    <p><strong>Internship: </strong>
                                                        <select class="form-control"
                                                            @change="updateInternshipStatus($event)"
                                                    ...
                                                    <p><strong>Current Program: </strong>
                                                        <select class="form-control"
                                                            @change="updateCurrentProgram($event)"
                                                            v-model="registration.current_program">
                                                            <option v-for="prog in programs"
                                                                :value="prog.intProgramID">
                                                                {{ prog.strProgramCode }}
                                                            </option>
                                                        </select>
                                                    </p>
                                                    <p><strong>Date Enrolled: </strong>
                                                        <input class="form-control"
                                                            type="datetime-local"
                                                            @blur="updateDateEnrolled($event)"
                                                            v-model="registration.dteRegistered">
                                                    </p>
                                                    <p><strong>Date Enlisted (date student is going
                                                            to enroll): </strong>
                                                        <input class="form-control"
                                                            type="datetime-local"
                                                            @blur="updateDateEnlisted($event)"
                                        ...
                                        <div>
                                            ...
                                            <select v-model="grad_status"
                                                v-if="registrar_privilages" class="form-control"
                            ...
                            <div v-if="advanced_privilages1"
                                :class="[(tab == 'tab_2') ? 'active' : '']" class="tab-pane"
                                id="tab_2">
                                <div class="box box-primary">
                                    <div class="box-body">
                                        <table v-if="registration"
                                            ...
                                            <tbody>
                                                <tr :style="(record.intFinalized == 2)?'background-color:#ccc;':''"
                                                    ...
                                                    <td v-if="record.v2 != 'OW'"
                                                        :style="(record.intFinalized == 2)?'font-weight:bold;':''">
                                                        {{ record.intFinalized >=1?record.v2:'NGS' }}
                                                    </td>
                                                    <td v-else style="font-weight:bold"> OW </td>
                                                    <td v-if="record.v3 != 'OW'"
                                                        :style="(record.intFinalized == 2)?'font-weight:bold;':''">
                                            ...
                                            <div class="row">
                                                <form @submit.prevent='assignElective'>
                                                    <div class="col-md-5">
                                                        ...
                                                        <select v-model="elective_classlist"
                                                            required class="form-control">
                                                            <option v-for="record in records"
                                                                :value='record.classlistID'>
                                                                {{ record.strCode }}
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label>Select Subject</label>
                                                        <select v-model="elective_subj" required
                                                            class="form-control">
                                                            <option v-for="elective in electives"
                                                                :value='elective.intSubjectID'>
                                                                {{ elective.strCode }}
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-2">
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-primary btn-block">Assign/Un-assign</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <thead>
                                                <tr class="text-center" colspan="4"> Attendance
                                                </tr>
                                                <tr>
                                                    <th>Month</th>
                                                    <th>School Days</th>
                            ...
                            <div v-if="reg_status == 'Enrolled'"
                                :class="[(tab == 'tab_3') ? 'active' : '']" class="tab-pane"
                                id="tab_3">
                                <div class="box box-primary">
                                    <div class="box-body">
                            ...
                            <div v-if="enlistment" :class="[(tab == 'tab_4') ? 'active' : '']"
                                class="tab-pane" id="tab_4">
                                <div class="box box-primary">
                                    <div class="box-body">
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                <tr v-for="subject in enlisted_subjects">
                                                    ...
                                                    <td><a target="_blank"
                                                            :href="base_url + 'unity/classlist_viewer/'+subject.intID">{{ subject.strClassName + subject.year + subject.strSection + subject.sub_section + subject.sub_section }}</a>
                                                    </td>
                                                    <td>{{ subject.sched_room + " " + subject.sched_day + " " + subject.sched_time }}
                                                    </td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td>
                                                        <button @click="enlistStudent"
                                                            class="btn btn-success">Enlist Advised
                                                            Subjects</button>
                                                    </td>
                                                </tr>
                                            </tfoot>
                            ...
                            <div v-if="registration" :class="[(tab == 'tab_5') ? 'active' : '']"
                                class="tab-pane" id="tab_5">
                                <div class="box box-primary">
                                    <div class="box-body">
                                        <table class="table table-condensed table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                <tr v-for="record in records"
                                                    style="font-size: 13px;">
                                                    <td>{{ record.strClassName + ' ' + record.year + record.strSection }}
                                                    </td>
                                                    <td>{{ record.sub_section!=null?record.sub_section:'' }}
                                                    </td>
                                                    <td>{{ record.strCode }}</td>
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body"> <?php echo $sched_table; ?> </div>
                                </div>
                            </div>
        ...
        <!-- modal start -->
        <div class="modal fade" id="loa-modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="modalLabel">Tag Student for Leave of Absence
                        </h4>
                    </div>
                    <div class="modal-body">
                        <form @submit.prevent="submitLoa()">
                            <div class="form-group">
                                ...
                                <select v-model="awol" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="input-reason" v-model.trim="loaDetails.loa_remarks"
                                    class="form-control" rows="2"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="loa-date">Date</label>
                                <div class="input-group col-sm-12">
                                    <input type="date" v-model="loaDetails.loa_date"
                                        class="form-control validate" id="loa-date"
...
new Vue({
                ...
                axios.get(this.base_url + 'unity/student_viewer_data/' + this.id +
                    ...
                    if (data.data.success) {
                        ...
                        for (i in this.term_balances)
                            if (this.term_balances[i].balance > 0) this
                                .show_alert = true;
                        if (data.data.scholarship.length > 0) {
                            var sch = "";
                            for (i in data.data.scholarship) sch += data
                                .data.scholarship[i].name + " ";
                            this.scholarship = {
                                name: sch
                            };
                        } else {
                        ...
                        if (data.data.discount.length > 0) {
                            var sch = "";
                            for (i in data.data.discount) sch += data.data
                                .discount[i].name + " ";
                            this.discount = {
                                name: sch
                            };
                        ...
                        this.registration_status = data.data.registration ?
                            data.data.registration.intROG : 0;
                        ...
                        this.curriculum_subjects = data.data
                            .curriculum_subjects;
                        this.sections = data.data.sections;
                        this.tuition_payment_link = data.data
                            .tuition_payment_link;
                        this.notif_message = data.data.notif_message;
                        this.enlistment = data.data.enlistment;
                        this.enlisted_subjects = data.data
                        .enlisted_subjects;
                        if (this.sections) this.add_subject.section = (this
                                .sections.length > 0) ? this.sections[0]
                            .intID : null;
                        this.add_subject.subject = (this.curriculum_subjects
                                .length > 0) ? this.curriculum_subjects[0]
                            .intSubjectID : null;
                        this.add_subject.studentID = this.id;
                        this.add_subject.activeSem = this.selected_ay;
                        this.advanced_privilages1 = data.data
                            .advanced_privilages1;
                        this.advanced_privilages2 = data.data
                            .advanced_privilages2;
                        ...
                        this.registrar_privilages = data.data
                            .registrar_privilages;
                        ...
                        axios.get(api_url + 'admissions/student-info/' +
                            this.student.slug).then((data) => {
                            this.applicant_data = data.data.data;
                            this.applicant_data.tos = this
                                .applicant_data.tos.charAt(0)
                                .toUpperCase() + this.applicant_data
                                .tos.slice(1);
                            for (i in this.applicant_data
                                .uploaded_requirements) {
                                this.applicant_data
                                    .uploaded_requirements[i].path =
                                    this.applicant_data
                                    .uploaded_requirements[i].path
                                    .replace("116.50.237.244",
                                        "smsapi.iacademy.edu.ph");
                                if (this.applicant_data
                                    .uploaded_requirements[i]
                                    .type == "2x2" || this
                                    .applicant_data
                                    .uploaded_requirements[i]
                                    .type == "2x2_foreign") this
                                    .picture = this.applicant_data
                                    .uploaded_requirements[i].path;
                            }
                        }).catch((error) => {
                            console.log(error);
    ...
    methods: {
        resetStatus: function() {
            let reset_url = base_url + 'unity/delete_registration/' + this.student
                .intID + '/' + this.active_sem.intID;
            Swal.fire({
        ...
        assignElective: function() {
            Swal.fire({
                ...
                preConfirm: (login) => {
                    var formdata = new FormData();
                    formdata.append('elective_classlist_id', this
                        .elective_subj);
                    formdata.append('subject_classlist_id', this
                        .elective_classlist);
                    formdata.append('student_id', this.student.intID);
                    return axios.post(base_url + 'unity/assign_elective',
                        formdata, {
                            headers: {
                                Authorization: `Bearer ${window.token}`
                            }
        ...
        enlistStudent: function(id) {
            Swal.fire({
                ...
                preConfirm: (login) => {
                    var formdata = new FormData();
                    formdata.append('subjects', JSON.stringify(this
                        .enlisted_subjects));
                    formdata.append('studentID', this.student.intID);
                    formdata.append('strAcademicYear', this.active_sem
                        .intID);
                    return axios.post(base_url +
                        'unity/enlist_from_advising', formdata, {
                            headers: {
                                Authorization: `Bearer ${window.token}`
                            }
                        }).then(data => {
                        this.loader_spinner = false;
                        if (data.data.success)
                            if (data.data.sid) document.location =
                                base_url +
                                'registrar/register_old_student/' +
                                data.data.sid + '/' + this
                                .active_sem.intID;
        ...
        removeFromClasslist: function(classlistID) {
            Swal.fire({
                ...
                preConfirm: (login) => {
                    ...
                    return axios.post(
                        '<?php echo base_url(); ?>unity/delete_student_cs',
                        formdata, {
                            headers: {
                                Authorization: `Bearer ${window.token}`
                            }
        ...
        printRF: function() {
            var mt = 35;
            if (this.campus == 'Makati') mt = 12;
            var url = base_url + 'pdf/student_viewer_registration_print/' + this.student
                .intID + '/' + this.applicant_data.id + '/' + this.active_sem.intID +
                '/' + mt;
            if (this.deficiencies.length > 0 || this.balance > 0) {
                Swal.fire({
                    ...
                    footer: '<a target="_blank" href="' + base_url +
                        'deficiencies/student_deficiencies/' + this.student
                        .intID + '">View Deficiencies</a>',
                    preConfirm: (login) => {
        ...
        changeTermSelected: function() {
            document.location = this.base_url + "unity/student_viewer/" + this.student
                .intID + "/" + this.sem_student + "/" + this.tab;
        },
        submitLoa: function() {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: (inputValue) => {
                            ...
                            for (const [key, value] of Object
                                .entries(this.loaDetails)) {
                                formdata.append(key, value);
                            }
                            formdata.append('term_id', this
                                .sem_student);
                            ...
                            formdata.append('password',
                                inputValue);
                            formdata.append('student_name', this
                                .student.strLastname + ' ' +
                                this.student.strLastname);
