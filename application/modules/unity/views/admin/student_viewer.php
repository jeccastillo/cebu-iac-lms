        ...
        <section class="content-header">
            <h1>
                <small>                    
                    ...
                    <a v-else-if="user_level == 2 || user_level == 3" class="btn btn-app" :href="base_url + 'department/load_subjects/' + student.intID + '/' + active_sem.intID">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li v-if="advanced_privilages1" :class="[(tab == 'tab_2') ? 'active' : '']"><a href="#tab_2" data-toggle="tab">Subjects</a></li>
                        <li v-if="reg_status == 'Enrolled'" :class="[(tab == 'tab_3') ? 'active' : '']"><a href="#tab_3" data-toggle="tab">Changes of Grades</a></li>
