                                    ...
                                    <table v-if="ledger_items.length > 0"
                                        ...
                                        <tbody>
                                            <tr v-for="item in ledger_items">
                                                ...
                                                <td :class="item.muted"><a
                                                        @click="cashierDetails(item.added_by)"
                                        ...
                                        <tr v-for="payment in other_payments">
                                            ...
                                            <td>
                                                ...
                                                <button
                                                    ...
                                                    class="btn btn-primary"
                                                    @click="setToPaid(payment.id)">Set to
                                                    paid</button>
                                                <button
...
new Vue({
    ...
    methods: {
        ...
        computeVat: function(){
            ...
            this.total_sales = parseFloat(parseFloat(this.request.invoice_amount) + parseFloat(this.request.invoice_amount_ves)) + parseFloat(this.invoice_amount_vzrs);            
