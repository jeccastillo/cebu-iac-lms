...
$config['tb_mas_users_columns'] = array("intID","slug","strStudentNumber","strLastname","strFirstname","strMiddlename","strProgramCode","MAX(intYearLevel)","strAcademicStanding","level");
...
$config['tb_mas_room_schedule_columns'] = array("intRoomSchedID","strCode","strClassName","tb_mas_classlist.year","strSection","sub_section","name","strDay","dteStart","dteEnd","date_specific","enumClassType","strRoomCode");
...
$config['tb_mas_block_sections_columns'] = array("intID","name","strProgramCode","tb_mas_block_sections.type");
