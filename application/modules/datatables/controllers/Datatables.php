...
class Datatables extends CI_Controller {
    ...
    public function data_tables_ajax_cs($sem = 0, $program = 0, $dissolved = 0, $has_faculty = 0, $status = 0, $modular = 0)
    {
        ...
        $aColumns = array("tb_mas_classlist.intID","strCode","strClassName","year","strSection","sub_section","cl_desc","slots","strLastname","strFirstname","intFinalized","conduct_grade");
        // $aColumns = array("intID","strStudentNumber","strLastname","strFirstname","strMiddlename","strProgramCode","intStudentYear","intROG");
        //$aColumns = array("intID","strFullName","strCourse","strSection");
        $sIndexColumn = "intID";
            ...
            if ( isset($_GET['bSearchable_'.$i]) && $_GET['bSearchable_'.$i] == "true" && $_GET['sSearch_'.$i] != '' )
            {
                ...
                if($table == "tb_mas_users" && $i  == 2){                        
                    ...
                    foreach($str as $letter){
                        if(count($str) >= 5 && $str[4] == "S"){
                            if($ct == 7 || $ct == 9)
                                $st .= "-";
                        }
                        elseif($str[0] != "C" && $str[0] != "T" && ($ct == 4 || $ct == 6))
                            $st .= "-";
