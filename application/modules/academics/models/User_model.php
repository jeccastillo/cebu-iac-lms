	...
	function generate_simple_hash()
		...
		function set_email_data($email, $subject, $content)
		{
			...
			//init configuration for email------------------------------------------------
				...
				$config['smtp_user'] = "joseph@stratuscast.com";
				$config['smtp_pass'] = "unearth1123581321!";
			...
			//-------------------------------------------------------------------------
			    $this->email->from("joseph@stratuscast.com","no-reply@ncaatv5.com");
			     $this->email->reply_to("no-reply@ncaatv5.com");
	         	    $this->email->to($email);
