        ...
        <div action="">
            <div class="box ">
                ...
                <div class="box-body" style="padding:2rem">
                    <form @submit.prevent="updateData">
                        <div class="row">
                            <div class="form-group col-xs-6">
                                ...
                                <input v-if="request.final == 0" type="text" name="year" required
                            ...
                            <div class="form-group col-xs-6">
                                ...
                                <input v-if="request.final == 0" type="number" step=".01"
                                    name="pricePerUnit" required class="form-control"
                                    id="pricePerUnit" placeholder="Enter Price per unit"
                            ...
                            <div class="form-group col-xs-6">
                                ...
                                <input v-if="request.final == 0" type="number" step=".01"
                                    name="pricePerUnitOnline" required class="form-control"
                                    id="pricePerUnitOnline" placeholder="Enter Price per unit"
                                    v-model='request.pricePerUnitOnline'>
                                <div v-else>{{ request.pricePerUnitOnline }}</div>
                            </div>
                            <div class="form-group col-xs-6">
                                <label for="year">Price Per Unit Hyflex</label>
                                <input v-if="request.final == 0" type="number" step=".01"
                                    name="pricePerUnitHyflex" required class="form-control"
                                    id="pricePerUnitHyflex" placeholder="Enter Price per unit"
                                    v-model='request.pricePerUnitHyflex'>
                                <div v-else>{{ request.pricePerUnitHyflex }}</div>
                            </div>
                            <div class="form-group col-xs-6">
                                <label for="year">Price Per Unit Hybrid</label>
                                <input v-if="request.final == 0" type="number" step=".01"
                                    name="pricePerUnitHybrid" required class="form-control"
                                    id="pricePerUnitHybrid" placeholder="Enter Price per unit"
                                    v-model='request.pricePerUnitHybrid'>
                                <div v-else>{{ request.pricePerUnitHybrid }}</div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="year">Percent Increase for installment</label>
                                <input v-if="request.final == 0" step="any" type="number" required
                                    class="form-control" placeholder="Enter Percentage"
                                    v-model='request.installmentIncrease'>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input v-if="request.final == 0" step="any" type="number" required
                                    class="form-control" placeholder="Enter Percentage"
                                    v-model='request.installmentDP'>
                                <div v-else>{{ request.installmentDP }}</div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="year">Fixed Down Payment for Installment (if blank or
                                    set to 0 to choose percent down payment)</label>
                                <input v-if="request.final == 0" step="any" type="number"
                                    class="form-control" placeholder="Enter Fixed Value"
                                    v-model='request.installmentFixed'>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input v-if="request.final == 0" step="any" type="number"
                                    class="form-control" placeholder="Enter Fixed Value"
                                    v-model='request.freeElectiveCount'>
                                <div v-else>{{ request.freeElectiveCount }}</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <button type="submit" v-if="request.final == 0"
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr v-for="item in request.elective ">
                                ...
                                <td><a href="#"
                                        @click.prevent.stop="deleteItem('elective',item.id)">Delete</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    ...
                                    <select required class="form-control"
                                        @change="selectType($event)" placeholder="Enter Fee Amount"
                                        v-model='elective.subject_id'>
                                        <option v-for="item in selectable_elective_subjects"
                                            :value="item.intID">
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <input step="any" type="number" required class="form-control"
                                        ...
                                        v-model='elective.tuition_amount'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">G12 1st Sem</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='elective.tuition_amount_online'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">G11 2nd Sem</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='elective.tuition_amount_hyflex'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">G12 2nd Sem</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='elective.tuition_amount_hybrid'>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr v-for="item in request.track">
                                <td>{{ item.strProgramCode + ' ' + item.strProgramDescription }}
                                </td>
                                <td>{{ item.tuition_amount }}</td>
                                <td>{{ item.tuition_amount_online }}</td>
                                <td>{{ item.tuition_amount_hyflex }}</td>
                                ...
                                <td>{{ item.type }}</td>
                                <td><a href="#"
                                        @click.prevent.stop="deleteItem('track',item.id)">Delete</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    ...
                                    <select required class="form-control"
                                        ...
                                        <option v-for="item in shs_programs"
                                            :value="item.intProgramID">
                                            {{ item.strProgramCode + " " + item.strProgramDescription }}
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group col-sm-3">
                                    ...
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='track.tuition_amount'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">G12 1st Sem</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='track.tuition_amount_online'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">G11 2nd Sem</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='track.tuition_amount_hyflex'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">G12 2nd Sem</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='track.tuition_amount_hybrid'>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                        ...
                        <tbody>
                            <tr v-for="item in request.program">
                                ...
                                <td><a v-if="request.final == 0" href="#"
                                        @click.prevent.stop="deleteItem('program',item.id)">Delete</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <form @submit.prevent="addExtra('program','Program',program)">
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    ...
                                    <select required class="form-control"
                                        @change="selectType($event)" placeholder="Enter Fee Amount"
                                        v-model='program.track_id'>
                                        <option v-for="item in college_programs"
                                            :value="item.intProgramID">
                                            {{ item.strProgramCode + " " + item.strProgramDescription }}
                                        </option>
                                    </select>
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='program.tuition_amount'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">Online Fee</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='program.tuition_amount_online'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">Hyflex Fee</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='program.tuition_amount_hyflex'>
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="year">Hybrid Fee</label>
                                    <input step="any" type="number" required class="form-control"
                                        placeholder="Enter Fee Amount"
                                        v-model='program.tuition_amount_hybrid'>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr v-if="request.year.includes('SHS')">
                                <th>Name</th>
                                <th>G11 1st Sem</th>
                                <th>G12 1st Sem</th>
                                <th>G11 2nd Sem</th>
                        ...
                        <tbody>
                            <tr v-for="item in request.misc">
                                ...
                                <td>{{ item.type }}</td>
                                <td><a v-if="request.final == 0" href="#"
                                        @click.prevent.stop="deleteItem('misc',item.intID)">Delete</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-8">
                                    ...
                                    <input type="text" required class="form-control"
                                        placeholder="Enter Name" v-model='misc.name'>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-3">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr v-for="item in request.lab_fees">
                                ...
                                <td><a v-if="request.final == 0" href="#"
                                        @click.prevent.stop="deleteItem('lab_fee',item.intID)">Delete</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <form @submit.prevent="addExtra('lab_fee','Laboratory',lab)">
                            <div class="row">
                                <div class="form-group col-xs-8">
                                    <label for="year">Name</label>
                                    <input type="text" required class="form-control"
                                        placeholder="Enter Name" v-model='lab.name'>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-3">
...
new Vue({
    ...
    mounted() {
        ...
        axios.get('<?php echo base_url(); ?>tuitionyear/tuition_info/' + this.id).then((
            data) => {
            this.request = data.data.data;
            if (!this.request.final) this.request.final = 0;
            ...
            this.selectable_elective_subjects = data.data
                .selectable_elective_subjects;
    ...
    methods: {
        selectType: function(event) {
            if (event.target.value == "isf") this.misc.name =
                "International Student Fee";
            if (event.target.value == "svf") this.misc.name = "Student Visa Fee";
        },
        addExtra: function(type, name, data) {
            Swal.fire({
                ...
                preConfirm: (login) => {
                    ...
                    if (type != "track" && type != "program" && type !=
                        "elective") formdata.append("tuitionYearID", this
                        .id);
                    else formdata.append("tuitionyear_id", this.id);
                    for (const [key, value] of Object.entries(data)) {
                        formdata.append(key, value);
                    }
                    return axios.post(
                        '<?php echo base_url(); ?>tuitionyear/submit_extra/' +
                        type, formdata, {
                            headers: {
        ...
        deleteItem: function(type, miscId) {
            Swal.fire({
                ...
                preConfirm: (login) => {
                    ...
                    return axios.post(
                        '<?php echo base_url(); ?>tuitionyear/delete_type/',
                        formdata, {
                            headers: {
                                Authorization: `Bearer ${window.token}`
                            }
        ...
        finalizeTuition: function(type) {
            Swal.fire({
                ...
                preConfirm: (login) => {
                    ...
                    return axios.post(
                        '<?php echo base_url(); ?>tuitionyear/finalize_tuition/',
                        formdata, {
                            headers: {
                                Authorization: `Bearer ${window.token}`
                            }
        ...
        updateData: function() {
            Swal.fire({
                ...
                preConfirm: (login) => {
                    ...
                    formdata.append("pricePerUnit", this.request
                        .pricePerUnit);
                    formdata.append("pricePerUnitOnline", this.request
                        .pricePerUnitOnline);
                    formdata.append("pricePerUnitHybrid", this.request
                        .pricePerUnitHybrid);
                    formdata.append("pricePerUnitHyflex", this.request
                        .pricePerUnitHyflex);
                    formdata.append("isDefault", this.request.isDefault);
                    formdata.append("installmentIncrease", this.request
                        .installmentIncrease);
                    formdata.append("installmentDP", this.request
                        .installmentDP);
