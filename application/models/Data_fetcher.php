...
//        
    ...
    function getCurriculumIDByCourse($id){
        $curriculum =  $this->db->select('intID')->from('tb_mas_curriculum')->where(array('intProgramID'=>$id,'active'=>'1'))->get()->first_row();
