...
//        
    ...
    {
        $bucket = "SELECT tb_mas_subjects.*, program FROM tb_mas_subjects JOIN tb_mas_prerequisites ON tb_mas_subjects.intID = tb_mas_prerequisites.intSubjectID  WHERE tb_mas_subjects.intID = ".$id;  
