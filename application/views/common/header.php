                ...
                <?php if($user['intUserLevel'] == 2 || $user['intUserLevel'] == 6 ): ?>
                        <li class="treeview <?php echo (isset($opentree) && $opentree=="cashier")?'active':''; ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?php echo (isset($page) && $page=="other_payments")?'active':''; ?>"><a href="<?php echo base_url() ?>finance/other_payments"><i class="ion ion-cash"></i> <span>Add Other Payment</span> </a></li>                                
                                ...
                                <li class="<?php echo (isset($page) && $page=="other_payments")?'active':''; ?>"><a href="<?php echo base_url() ?>finance/payments/0/1"><i class="ion ion-cash"></i> <span>Other Payments Report</span> </a></li>                                
