                ...
                <?php if($user['intUserLevel'] == 2 || $user['intUserLevel'] == 3 ): ?>                   
                        <li class="treeview <?php echo (isset($opentree) && $opentree=="registrar")?'active':''; ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?php echo (isset($page) && $page=="tuitionyear")?'active':''; ?>"><a href="<?php echo base_url(); ?>tuitionyear/add_tuition_year" style="margin-left: 10px;"><i class="ion ion-ios-plus-empty"></i> Add Tuition Year</a></li>
                            </ul>
