    ...
    <body class="sidebar-mini <?php echo $skin; ?>">
        <header class="main-header">
            ...
            <a href="<?php echo base_url(); ?>" class="logo">
              ...
              <span class="logo-lg"><b>CCT</b>Unity</span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown messages-menu hidden-xs">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                              ...
                              <span class="label <?php echo ($unread_messages==0)?'hide':'' ?> label-success unread-message-alert"><?php echo $unread_messages; ?></span>
                            </a>
                            <ul class="dropdown-menu">
                              <li class="header">You have <span class="unread-message-text"><?php echo $unread_messages; ?></span> unread messages</li>
                                <li>
                              ...
                              <li class="footer"><a href="<?php echo base_url(); ?>messages/view_messages">See All Messages</a></li>
                            </ul>
                      </li>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        <a style="color:#fff;" href="<?php echo base_url(); ?>faculty/my_profile"><?php echo $user['strFirstname']." ".$user['strLastname']; ?></a>
          ...
          <aside class="main-sidebar">
            ...
            <section class="sidebar">                 
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo (isset($page) && $page=="dashboard")?'active':''; ?>"><a href="<?php echo base_url() ?>"><i class="fa fa-home text-green"></i> <span>Dashboard</span></a></li>
...
<!--                            <li class="<?php echo (isset($page) && $page=="view_students2")?'active':''; ?>"><a href="<?php echo base_url(); ?>student/view_all_students2" style="margin-left: 10px;"><i class="ion ion-eye"></i> View Students' Pass</a></li> -->
                ...
                <?php if(in_array($user['intUserLevel'],array(2,5)) ): ?>
                    <li class="treeview <?php echo (isset($opentree) && $opentree=="applicants")?'active':''; ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php if(in_array($user['intUserLevel'],array(2,3,4,5)) ): ?>
                            <li class="<?php echo (isset($page) && $page=="add_applicant")?'active':''; ?>"><a href="<?php echo base_url(); ?>admissions/add_applicant" style="margin-left: 10px;"><i class="ion ion-android-person-add"></i> Add an Applicant</a></li>
                            <?php endif; ?>
                            <li class="<?php echo (isset($page) && $page=="view_applicants")?'active':''; ?>"><a href="<?php echo base_url(); ?>admissions/view_all_applicants" style="margin-left: 10px;"><i class="ion ion-eye"></i> View Applicants</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
