<aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      ...
      <li class="<?php echo ($page == "dashboard")?'active':''; ?>"><a href="#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <?php endif; ?>
      <li class="<?php echo ($page != "dashboard")?'active':''; ?>"><a href="#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
        <h3 class="control-sidebar-heading">System Statistics</h3>
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:void(0)">
              <i class="menu-icon ion ion-university bg-red"></i>

              <div class="menu-info">
                <h4 class="control-sidebar-subheading">REGISTERED STUDENTS</h4>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">TOTAL STUDENTS</h4>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">7TH DISTRICT SCHOLARS</h4>

                <p><?php echo $scholar1; ?></p>
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">RESIDENT SCHOLARS</h4>

                <p><?php echo $scholar2; ?></p>
              </div>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">ALL CLASSLISTS</h4>

                <p><?php echo $allclasses; ?></p>
              </div>
            </a>
          </li>
        </ul>
      ...
      <div class="tab-pane <?php echo ($page != "dashboard")?'active':''; ?>" id="control-sidebar-settings-tab">
        <form method="post">
          <h3 class="control-sidebar-heading">General Links</h3>
          <ul class="control-sidebar-menu">
          <li>
            <a href="<?php echo base_url(); ?>unity/registered_students_report">
              <i class="menu-icon ion ion-university bg-yellow"></i>
            ...
            <li>
                <a href="<?php echo base_url(); ?>pdf/student_viewer_registration_blank_print">
                  <i class="menu-icon ion ion-document-text bg-green"></i>

                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">BLANK REG FORM</h4>
              ...
              <li>
                <a href="<?php echo base_url(); ?>pdf/student_viewer_advising_blank_print">
                  <i class="menu-icon ion ion-document-text bg-green"></i>

                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">BLANK ADVISING FORM</h4>
              ...
              <li>
                <a href="<?php echo base_url(); ?>pdf/student_viewer_blank_rog_print">
                  <i class="menu-icon ion ion-document-text bg-green"></i>

                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">BLANK ROG</h4>
              ...
              <li>
                <a href="<?php echo base_url(); ?>unity/enrollment_summary">
                  <i class="menu-icon ion ion-folder bg-red"></i>

                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">ENROLLMENT SUMMARY</h4>
...
<script>
    ...
    $(document).ready(function(){
        ...
        */
        ...
        $("#select-sem-admin").change(function(e){
            document.location = "<?php echo base_url(); ?>unity/view_classlist_archive_admin/"+$(this).val();
        
        });
        
        $("#select-sem-dept").change(function(e){
            document.location = "<?php echo base_url(); ?>unity/view_classlist_archive_dept/"+$(this).val();
        
        });
        
        $("#select-sem-student").change(function(e){
            if($(this).val() != 0)
                document.location = "<?php echo base_url(); ?>unity/student_viewer/"+$("#student-id").val()+"/"+$(this).val();
        
        });
        $("#select-sem-report1").change(function(e){
            document.location = "<?php echo base_url(); ?>unity/registered_students_report/"+$(this).val();
        ...
        $("#submit-subject").click(function(e){
                var csid = $(this).attr('rel');
                var parent = $(this).parent().parent();
                var data = {'strCode':$("#strCode").val(),'strUnits':$("#strUnits").val(),'strDescription':$("#strDescription").val()};
                ...
                else
                {
                    $.ajax({
                            ...
                            'dataType':'json',
                            'success':function(ret){
                                $("#subjects").append("<option value='"+ret.newid+"' >"+ret.code+"</option>");
                                $('#myModal').modal('hide');
                                $("#subjects option[value='"+ret.newid+"']").attr("selected", "selected");
       ...
       $("#enumScholarship").change(function(){
        ...
        $("#load-subjects").click(function(e){
                ...
                var data = {'intStudentID':$("#studentID").val(),'sem':$("#activeSem").val()};
                ...
                $.ajax({
                        ...
                        'success':function(ret){
                            ...
                            if(ret.subjects.length > 0){
                                ...
                                {
                                    container.append("<div><input type='hidden' class='subject-id' name='subjects-loaded[]' value='"+ret.subjects[i].intID+"'><br> <div class='row'><div class='col-xs-3 subject-code'>"+ret.subjects[i].strCode+"</div><div class='col-xs-3 subject-description'>"+ret.subjects[i].strDescription+"</div><div class='col-xs-3 subject-units'>"+ret.subjects[i].strUnits+"</div><div class='col-xs-3'><a class='btn remove-subject-loaded btn-default  btn-flat'><i class='fa fa-minus'></i></a></div></div><hr /></div>");
                                    if(ret.subjects[i].classlists.length > 0){
                                        var str = "<div><select class='form-control' name='section-"+ret.subjects[i].intID+"'><option value=0>Auto</option><option value='new'>New</option>";
                                    
                                        for(j in ret.subjects[i].classlists)
                                        {
                                            var str = str + "<option value ='"+ret.subjects[i].classlists[j].intID+"'>Section: "+ret.subjects[i].classlists[j].strSection+"("+ret.subjects[i].classlists[j].numCount+")</option>";    
                                        }
                                ...
                                $("#subject-to-add option[value='"+ret.subjects[i].intID+"']").remove();

                                total_units = parseInt(total_units)+parseInt(ret.subjects[i].strUnits);
                                ...
                                $(".remove-subject-loaded").click(function(){
                                    ...
                                    scode = mainContainer.find('.subject-code').html()+" "+mainContainer.find('.subject-description').html();
                ...
                $.ajax({
                        ...
                        'success':function(ret){
                            ...
                            if(ret.subjects.length > 0){
                                for(i in ret.subjects)
                                {
                                    container.append("<div><input type='hidden' class='subject-id' name='subjects-loaded[]' value='"+ret.subjects[i].subjectID+"'><br> <div class='row'><div class='col-xs-3 subject-code'>"+ret.subjects[i].strCode+"</div><div class='col-xs-3 subject-description'>"+ret.subjects[i].strDescription+"</div><div class='col-xs-3 subject-units'>"+ret.subjects[i].strUnits+"</div><div class='col-xs-3'><a class='btn remove-subject-loaded btn-default  btn-flat'><i class='fa fa-minus'></i></a></div></div><hr /></div>");
        ...
        $("#submitSubject").click(function(e){
            ...
            e.preventDefault();
                ...
                if(section!=""){
                var data = {'code':$("#subject-to-add").val(),'section':section,'studentID':studentID};
                ...
                $.ajax({
                        ...
                        'success':function(ret){
                              ...
                              else if(ret.message == "failed4")
                            {
                                ...
                                document.location = "<?php echo base_url(); ?>unity/student_viewer/"+studentID+"/"+activeSem; 
                            }
                        }
                });
                }
        ...
        $("#add-subject-loaded").click(function(e){
               e.preventDefault();
                ...
                var section = $("#sections-to-add").val();
                if(section!=""){
                var data = {'intID':$("#subject-to-add").val()};
                ...
                $.ajax({
                        ...
                        'success':function(ret){
                                ...
                                container.append("<div><input type='hidden' name='subjects-loaded[]' class='subject-id' value='"+ret.subject.intID+"'><input type='hidden' name='subjects-section[]' value='"+section+"'><br> <div class='row'><div class='col-xs-3 subject-code'>"+ret.subject.strCode+"</div><div class='col-xs-3 subject-description'>"+ret.subject.strDescription+"</div><div class='col-xs-3 subject-units'>"+ret.subject.strUnits+"</div><div class='col-xs-3'><a class='btn remove-subject-loaded2 btn-default  btn-flat'><i class='fa fa-minus'></i></a></div></div><hr /></div>");
                            
                        
                            $("#subject-to-add option[value='"+subjectID+"']").remove();
                            reset_sections($("#strAcademicYear").val());
                            if($("#enumScholarship").val() == "paying")
                                total_units = parseInt(total_units)+parseInt(ret.subject.strUnits);
                            ...
                            $(".remove-subject-loaded2").click(function(){
                                ...
                                if(ret.subject.strCode == mainContainer.find('.subject-code').html())
                                    total_units = parseInt(total_units)-parseInt(sunits);
        ...
        $("#submit-ay").click(function(e){
                    var submit_sy = confirm("Are you sure you want to switch school year? All students will be set to inactive status and all subjects will be finalized");
               if(submit_sy){
                    $("#set-ay-form").submit();
               }
    ...
    function return_tuition()
    {
        ...
        var data = {'subjects_loaded':sj,'scholarship':$("#enumScholarship").val(),'stype':$("#transcrossSelect").val()};
        $.ajax({
    ...
    function load_subjects()
    {
        $("#subject-to-add").find('option').remove(); 
            ...
            var data = {'curriculum':curriculum};
    ...
    function reset_sections(sem)
    {
        ...
        var data = {'subject_id':subject,'sem':sem};
    ...
    function get_messages() { 
        $.ajax({
           ...
           success: function(data){
                ...
                {
                    htappend = '<li><a href="<?php echo base_url()."messages/view_message/" ?>'+data.messages[i].intMessageUserID+'"><div class="pull-left"></div><h4>'+data.messages[i].strFirstname+" "+data.messages[i].strLastname+'<small><i class="fa fa-clock-o"></i> '+data.messages[i].dteDate+'</small></h4><p>'+data.messages[i].strSubject+'</p></a></li><!-- end message -->';
    ...
    function getOnlineUsers() { 
        ...
        $.ajax({
           ...
           success: function(data){
                for(i in data.users)
                {
                    htappend = '<div class="form-group"><label class="control-sidebar-subheading"><i class="fa fa-circle text-success"></i> <a class="text-muted" href="<?php echo base_url(); ?>messages/compose_message/'+data.users[i].intID+'">'+ data.users[i].strFirstname +' '+data.users[i].strLastname+'</a></label></div>';
